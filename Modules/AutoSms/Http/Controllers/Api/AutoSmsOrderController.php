...
class AutoSmsOrderController extends Controller
{
    /**
     * Create a new order with validation
     * POST /api/auto-sms/orders/create
     */
     ...
     * POST /api/auto-sms/orders/verify-payment
     */
    public function verifyPayment(Request $request)
    {
        try {
            ...
            $transaction = AutoSmsTransaction::where('user_id', $user->id)
            ...
            if ($transaction) {
                ...
                DB::transaction(function () use ($order, $transaction) {
                    $order->update([
                        ...
                        'autosms_transaction_id' => $transaction->id,
                        'paid_at' => now(),
                    ]);
    ...
    /**
     * Cancel an order
     * POST /api/auto-sms/orders/{id}/cancel
     */
