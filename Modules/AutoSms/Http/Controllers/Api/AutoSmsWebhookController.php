...
class AutoSmsWebhookController extends Controller
{
    /**
     * Register a webhook URL for the authenticated user
     * POST /api/auto-sms/webhooks
     */
    ...
    /**
     * Delete webhook
     * DELETE /api/auto-sms/webhooks/{id}
     */
     ...
     * POST /api/auto-sms/webhooks/test
     */
     ...
     */
    public static function sendTransactionWebhook(AutoSmsTransaction $transaction)
    {
     ...
     */
    private function sendWebhook(AutoSmsWebhook $webhook, array $payload)
    {
        try {
