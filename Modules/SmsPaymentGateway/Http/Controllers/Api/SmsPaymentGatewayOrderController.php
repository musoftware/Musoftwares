...
class SmsPaymentGatewayOrderController extends Controller
{
    /**
     * Create a new order with validation
     * POST /api/sms-payment-gateway/orders/create
     */
    public function create(Request $request)
    {
        try {
            ...
            $order = PaymentOrder::create([
                ...
                'notes' => $request->notes,
                'is_test' => $user->sms_payment_gateway_test_mode ?? false,
            ]);
     ...
     * POST /api/sms-payment-gateway/orders/verify-payment
     */
    public function verifyPayment(Request $request)
    {
        try {
            ...
            $transaction = SmsPaymentGatewayTransaction::where('user_id', $user->id)
    ...
    /**
     * Get order status
     * GET /api/sms-payment-gateway/orders/{id}
     */
    ...
    /**
     * Cancel an order
     * POST /api/sms-payment-gateway/orders/{id}/cancel
     */
    ...
    /**
     * List user orders
     * GET /api/sms-payment-gateway/orders
     */
