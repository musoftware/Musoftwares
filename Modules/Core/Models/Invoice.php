...
use Modules\Core\Models\CharityCounter;
...
class Invoice extends Model
{
    ...
    public static function UnpaidInvoicesBusiness()
    {
        ...
        foreach ($invoices as $invoice) {
            $unpaid += CurrenciesExchange::RateToday($invoice->unpaid, $invoice->currency, \Modules\Core\Models\CurrenciesExchange::BusinessCurrency());
        }
        return $unpaid;
    }
    ...
    {
        return $this->belongsTo(\Modules\Core\Models\Project::class);
    }
    ...
    public function cancel_invoice()
    {
        DB::transaction(function () {
            ...
            if (!empty($this->project_id)) {
                $project = \Modules\Core\Models\Project::find($this->project_id);
                $client = User::find($this->user_id);
