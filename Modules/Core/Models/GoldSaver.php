...
class GoldSaver extends Model
{
    ...
    {
        $carat24_price = round($gold_price['price_24k'], 2);
        $carat21_price = round($gold_price['price_21k'], 2);
        $carat22_price = round($gold_price['price_22k'], 2);
        $carat18_price = round($gold_price['price_18k'], 2);
        $carat14_price = round($gold_price['price_14k'], 2);
        $carat10_price = round($gold_price['price_10k'], 2);
