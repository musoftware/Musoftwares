...
class FileFolder extends Model
{
    ...
    {
        return $this->hasMany(\Modules\Core\Models\File::class, 'folder_id');
    }

    public function fileFolders()
    {
        return $this->hasMany(\Modules\Core\Models\FileFolder::class, 'folder_id');
    }

    public function parent_folder()
    {
        return $this->belongsTo(\Modules\Core\Models\FileFolder::class, 'folder_id');
    }
