...
class WidgetController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        $user = User::where('text-payment-gateway_verification_secret', $request->key)->first();
        ...
        return view('text-payment-gateway::widget.iframe', [
            'amount' => $request->amount,
            'reference' => $request->reference,
            'phone' => $request->phone,
            'redirectUrl' => $request->redirect_url,
            'pollingUrl' => route('text-payment-gateway.widget.status', $request->query()),
