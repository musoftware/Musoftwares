...
class TextPaymentGatewayWebhookController extends Controller
{
    /**
     * Register a webhook URL for the authenticated user
     * POST /api/text-payment-gateway/webhooks
     */
    public function register(Request $request)
    {
        ...
        // Create new webhook
        $webhook = TextPaymentGatewayWebhook::create([
            'user_id' => $user->id,
            'webhook_url' => $request->webhook_url,
     ...
     * GET /api/text-payment-gateway/webhooks
     */
     ...
     * PUT /api/text-payment-gateway/webhooks/{id}
     */
    ...
    /**
     * Delete webhook
     * DELETE /api/text-payment-gateway/webhooks/{id}
     */
     ...
     * POST /api/text-payment-gateway/webhooks/test
     */
     ...
     */
    public static function sendTransactionWebhook(TextPaymentGatewayTransaction $transaction)
    {
     ...
     */
    private function sendWebhook(TextPaymentGatewayWebhook $webhook, array $payload)
    {
        try {
