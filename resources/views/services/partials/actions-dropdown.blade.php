<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end">
        ...
        <li class="dropdown-header">
            <i class="ti ti-world me-2"></i>Landing Page
        ...
        @if (Auth::user()->hasRole('admin'))
            ...
            @if (!$service->user->hasRole('admin'))
                <li>
                    <a class="dropdown-item text-warning" href="#" onclick="event.preventDefault(); if (confirm('Are you sure you want to deactivate this service?')) document.getElementById('deactivate-form-{{ $service->id }}').submit();">
        ...
        <li><hr class="dropdown-divider"></li>
        <li>
            <a class="dropdown-item text-danger" href="#" onclick="event.preventDefault(); if (confirm('Are you sure you want to remove this service?')) document.getElementById('delete-form-{{ $service->id }}').submit();">
