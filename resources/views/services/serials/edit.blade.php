...
@section('content')
    <div class="dashboard-container at-mobile-scroll-fix">
        <x-client.section-header 
            icon="ti ti-edit" 
            title="Edit Serial" 
            subtitle="Update serial information">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <x-client.form-card icon="edit" iconClass="text-primary" title="Serial Details">
                        <form action="{{ route('services.serials.update', [$serial->service, $serial]) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="form-text">Leave blank if this serial does not expire.</div>
                            </div>
