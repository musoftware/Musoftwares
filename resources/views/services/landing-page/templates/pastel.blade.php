{{-- Template: Pastel / Soft Color UI - Light colors, calm tones, soft shadows --}}
<style>
    body {
        background: linear-gradient(135deg, #ffeef8 0%, #f0f9ff 50%, #f0fff4 100%);
    ...
    .pricing-card:hover {
        ...
        box-shadow: 0 10px 30px rgba(255, 179, 217, 0.35);
        border-color: #b3d9ff;
    }
    ...
    .description-content {
        ...
        border-radius: 25px;
        border: 3px solid #ffb3d9;
        box-shadow: 0 6px 20px rgba(255, 179, 217, 0.2);
    }
    ...
    .description-content[dir="rtl"] blockquote {
        ...
        margin-right: 20px;
        margin-left: 0;
        background: linear-gradient(90deg, rgba(255, 179, 217, 0.2) 0%, transparent 100%);
    }
