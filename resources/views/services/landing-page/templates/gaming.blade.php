{{-- Template: Gaming / Hero UI - Bold typography, animated backgrounds, strong gradients --}}
<style>
    ...
    .landing-hero {
        background: linear-gradient(135deg, #1a0033 0%, #000033 50%, #1a0033 100%);
        color: white;
        padding: 140px 0;
        text-align: center;
        position: relative;
    ...
    .section-padding::before {
        ...
        bottom: 0;
        background: 
            linear-gradient(45deg, transparent 48%, rgba(255, 0, 255, 0.05) 49%, rgba(255, 0, 255, 0.05) 51%, transparent 52%),
            ...
            <div class="pricing-grid">
                @foreach($landingPage->pricingTables as $pricing)
                    <div class="pricing-card {{ $pricing->is_popular ? 'popular' : '' }}">
                        <h3 style="color: #ffffff; font-weight: 900; margin-bottom: 15px; font-family: 'Orbitron', monospace; text-transform: uppercase; letter-spacing: 2px;">{{ $pricing->plan_name }}</h3>
                        @if($pricing->description)
                            <p style="margin-top: 10px; color: #00ffff; text-shadow: 0 0 10px rgba(0, 255, 255, 0.8);">{{ $pricing->description }}</p>
                        @endif
