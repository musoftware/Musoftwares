        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div class="lg:col-span-5 space-y-6">
                ...
                <div class="pt-6 flex flex-wrap gap-4 font-mono text-xs">
                    ...
                    <a href="https://wa.me/201015218548?text={{ urlencode('Hello Mahmoud, I am interested in discussing a project similar to ' . ($project['title_en'] ?? $title)) }}" target="_blank" rel="noopener noreferrer" class="px-6 py-3.5 bg-[#748660] text-[#0F140A] font-bold uppercase tracking-widest hover:bg-[#60704E] transition-all flex items-center gap-2">
