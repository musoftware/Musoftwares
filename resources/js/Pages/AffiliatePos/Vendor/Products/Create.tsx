        ...
        <div className="p-6 max-w-4xl mx-auto space-y-6 font-sans">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Create a new simple product for the affiliate catalog.</p>
                </div>
            </div>
                ...
                <Card className="shadow-sm border-gray-200 bg-white">
                    <CardHeader className="bg-gray-50/50 border-b p-5">
                        <CardTitle className="text-lg flex items-center gap-2">
                            <PackagePlus className="w-5 h-5 text-gray-500" /> Basic Information
                        </CardTitle>
                    ...
                    <CardContent className="p-6 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2 col-span-2 md:col-span-1">
                                <label className="text-sm font-medium text-gray-700">Initial Stock Quantity</label>
                                <Input 
                                    type="number" 
                                    value={data.stock} 
