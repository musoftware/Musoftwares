            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-xl border shadow-sm md:col-span-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="mt-2">
                            <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider block">Title / Description</span>
                        ...
                        <div className="mt-2">
                            <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider block">Note / Reason</span>
                ...
                <div className="bg-white p-6 rounded-xl border shadow-sm flex flex-col justify-between">
                    <div>
                        <h3 className="text-lg font-bold text-slate-900 mb-4 pb-2 border-b">Payroll Stats</h3>
                    ...
                    <div className="mt-4 pt-4 border-t text-xs text-gray-400 flex items-start gap-1">
                        ...
                        <span>Cumulative paid represents the total amount generated in transaction records for this employee.</span>
                    </div>
                </div>
            </div>
                        ...
                        <div>
                            {transactions.length === 0 ? (
                                <div className="text-center py-8 text-gray-500">
                                    ...
                                    <p className="text-sm">No payroll transactions have been recorded yet for this salary schedule.</p>
                                </div>
                            ) : (
