            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-xl border shadow-sm flex flex-col justify-between">
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-sm font-bold text-slate-900 bg-green-50 px-2 py-0.5 border border-green-100 rounded">
                    ...
                    <div className="mt-4 pt-4 border-t text-xs text-gray-400 flex items-start gap-1">
                        ...
                        <span>{__('general.the_cumulative_revenue_is_calculated_based_on_generated_transactions_associated_with_this_schedule')}</span>
                    </div>
                </div>
            </div>
                        ...
                        <div>
                            {transactions.length === 0 ? (
                                <div className="text-center py-8 text-gray-500">
                                    ...
                                    <p className="text-sm">{__('general.no_transactions_have_been_recorded_yet_for_this_recurring_income')}</p>
                                </div>
                            ) : (
