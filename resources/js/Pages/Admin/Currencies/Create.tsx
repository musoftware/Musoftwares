...
export default function Create() {
    ...
    return (
        <AdminSidebarLayout title={__('admin.create_currency')} header={__('admin.create_currency')}>
            <Head title={__('admin.create_currency')} />
            ...
            <div className="w-full max-w-3xl space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-semibold text-slate-900">{__('admin.create_currency')}</h1>
