...
export default function Create({ services }: CreateProps) {
    ...
    const submit = (e: React.FormEvent) => {
        ...
        post('/admin/marketplace/service-playbooks', {
            onSuccess: () => toast.success(__('service_playbooks.created_success')),
        });
    };

    return (
        <AdminSidebarLayout header={__('service_playbooks.create_new')}>
            <Head title={`${__('service_playbooks.create_new')} - ${__('service_playbooks.admin_title')}`} />
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <Card className="border-slate-200 shadow-sm">
                        <CardHeader className="border-b border-slate-100 bg-slate-50/50">
                            ...
                            <CardDescription className="text-xs text-slate-500">
                                {__('service_playbooks.basic_info_desc')}
                            </CardDescription>
                        </CardHeader>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder={__('service_playbooks.field_title_placeholder')}
                                        required
                                        className="bg-white"
                                    />
                    ...
                    <Card className="border-slate-200 shadow-sm">
                        <CardHeader className="border-b border-slate-100 bg-slate-50/50 flex flex-row items-center justify-between">
                            <div>
                                ...
                                <CardDescription className="text-xs text-slate-500">
                                    {__('service_playbooks.marketing_section_desc')}
                                </CardDescription>
                            </div>
                            <Button
                                type="button"
                        ...
                        <CardContent className="p-6">
                            <Textarea
                                ...
                                placeholder={__('service_playbooks.marketing_section_desc')}
                    ...
                    <Card className="border-slate-200 shadow-sm">
                        <CardHeader className="border-b border-slate-100 bg-slate-50/50 flex flex-row items-center justify-between">
                            <div>
                                ...
                                <CardDescription className="text-xs text-slate-500">
                                    {__('service_playbooks.pricing_section_desc')}
                                </CardDescription>
                            </div>
                            <Button
                                type="button"
                    ...
                    <Card className="border-slate-200 shadow-sm">
                        <CardHeader className="border-b border-slate-100 bg-slate-50/50 flex flex-row items-center justify-between">
                            <div>
                                ...
                                <CardDescription className="text-xs text-slate-500">
                                    {__('service_playbooks.reqs_section_desc')}
                                </CardDescription>
                            </div>
                            <Button
                                type="button"
                    ...
                    <Card className="border-slate-200 shadow-sm">
                        <CardHeader className="border-b border-slate-100 bg-slate-50/50 flex flex-row items-center justify-between">
                            <div>
                                ...
                                <CardDescription className="text-xs text-slate-500">
                                    {__('service_playbooks.workflow_section_desc')}
                                </CardDescription>
                            </div>
                            <Button
                                type="button"
                    ...
                    <Card className="border-slate-200 shadow-sm">
                        <CardHeader className="border-b border-slate-100 bg-slate-50/50 flex flex-row items-center justify-between">
                            <div>
                                ...
                                <CardDescription className="text-xs text-slate-500">
                                    {__('service_playbooks.thankyou_section_desc')}
                                </CardDescription>
                            </div>
                            <Button
                                type="button"
                        ...
                        <CardContent className="p-6">
                            <Textarea
                                ...
                                placeholder={__('service_playbooks.thankyou_section_desc')}
                    ...
                    <Card className="border-slate-200 shadow-sm">
                        <CardHeader className="border-b border-slate-100 bg-slate-50/50">
                            ...
                            <CardDescription className="text-xs text-slate-500">
                                {__('service_playbooks.notes_section_desc')}
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="p-6">
                            <Textarea
                                ...
                                placeholder={__('service_playbooks.notes_section_desc')}
                                className="bg-white text-sm"
                            />
                    ...
                    <div className="flex items-center justify-end gap-3 pt-4">
                        ...
                        <Button type="submit" disabled={processing} className="bg-slate-900 hover:bg-slate-800 text-white gap-2 font-medium px-6">
                            ...
                            {processing ? __('common.saving') : __('service_playbooks.save')}
                        </Button>
                    </div>
                </form>
            </div>
