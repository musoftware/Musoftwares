        ...
        <AdminSidebarLayout title={client.name} header="Payment Gateway">
            ...
            <div className="mb-6 rounded-xl border border-gray-100 bg-white p-5 shadow-sm">
                ...
                <div className="mt-4 rounded-lg bg-yellow-50 border border-yellow-200 p-3 flex items-start gap-2">
                    ...
                    <p className="text-xs text-yellow-700">{__('general.keep_these_secrets_confidential_use_the_webhook_secret_to_verify_incoming_payment_notifications_from_musoftware')}</p>
                </div>
            </div>
