...
export default function Show({ proposal }: { proposal: any }) {
    ...
    return (
        <AdminSidebarLayout title="Proposal Details" header="Proposal Details">
            <div className="mb-6">
            ...
            <div className="bg-white rounded-lg shadow p-6 max-w-4xl">
                <div className="flex justify-between items-start border-b pb-4 mb-4">
                    <div>
                        ...
                        <div className="text-sm text-gray-500">Submitted on: {new Date(proposal.created_at).toLocaleDateString()}</div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div className="bg-gray-50 p-4 rounded-md">
                        <h3 className="text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">Freelancer</h3>
                        {proposal.freelancer ? (
                            <>
                    ...
                    <div className="bg-gray-50 p-4 rounded-md">
                        <h3 className="text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">Bid Details</h3>
                        <p className="text-2xl font-bold text-gray-900 mb-1">{proposal.formatted_bid_amount}</p>
                        <p className="text-sm text-gray-600">Estimated Duration: {proposal.estimated_duration || 'Not specified'}</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="bg-gray-50 p-5 rounded-lg whitespace-pre-wrap text-gray-700 leading-relaxed border border-gray-100 min-h-[150px]">
                        {proposal.cover_letter || <span className="text-gray-400 italic">No cover letter provided.</span>}
                    </div>
                </div>
            </div>
        </AdminSidebarLayout>
