                ...
                <div className="p-6 space-y-8 flex-1">
                    ...
                    <div className="space-y-4 pt-2">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <Button variant="outline" className="flex-col items-start h-auto py-3 px-4 gap-2 bg-white hover:bg-slate-50 shadow-sm" onClick={() => onLoginAs(client.id)}>
                                <LogIn className="h-4 w-4 text-rose-500" /> 
                                <span className="font-normal text-slate-700">Login As</span>
                            </Button>
                            <Button variant="outline" className="flex-col items-start h-auto py-3 px-4 gap-2 bg-white hover:bg-slate-50 shadow-sm" onClick={() => onResetPassword(client.id)}>
