...
export default function Files({ client }) {
    return (
        <AdminSidebarLayout title={__('general.user_files')} header="User Files">
            ...
            <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <Card>
                    <CardContent className="p-12 text-center">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 mb-2">{__('general.media_manager_upgrade_in_progress')}</h3>
