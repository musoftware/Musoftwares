                            ...
                            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 shrink-0">
                                <div className="bg-slate-50 border border-slate-100 rounded-lg p-3 text-center sm:text-start">
                                    ...
                                    <span className="text-lg font-mono font-bold text-slate-900">
                                        {formatCurrency(tenant.revenue, (tenant as any).currency)}
                                    </span>
                                </div>
                                <Button 
                                    onClick={handleImpersonate}
                                    className="bg-slate-900 hover:bg-slate-900 text-white font-semibold flex items-center justify-center gap-2 py-5 shadow-none border-0"
                                >
