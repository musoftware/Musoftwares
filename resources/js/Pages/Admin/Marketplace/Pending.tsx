                                ...
                                >
                                    <div className="relative shrink-0 bg-slate-100 md:w-64 border-b md:border-b-0 md:border-e border-slate-200">
                                        {service.gallery && service.gallery.length > 0 ? (
                                            <img
                                                src={service.gallery[0].startsWith('http') ? service.gallery[0] : (service.gallery[0].startsWith('/') ? service.gallery[0] : `/uploads/${service.gallery[0].replace(/^storage\//, '').replace(/^uploads\//, '')}`)}
                                                alt={service.title}
