                                ...
                                <tbody className="divide-y divide-border/40">
                                    {filtered.map((r: any) => (
                                        <tr key={r.id} className="hover:bg-surface-raised/50 transition-colors">
                                            ...
                                            <td className="px-4 py-3.5">
                                                <span className={`font-mono font-semibold text-sm ${r.balance <= 0 ? 'text-red-500' : 'text-slate-900'}`}>
                                            ...
                                            <td className="px-4 py-3.5">
                                                {r.sharing_flagged > 0 ? (
                                                    ...
                                                    <span className="inline-flex items-center gap-1 text-xs text-slate-900">
