...
interface PayGuestPayLinkProps {
    payLink: string;
    userId: number;
    whatsappSent: boolean;
}

export default function PayGuestPayLink({ payLink, userId, whatsappSent }: PayGuestPayLinkProps) {
    return (
        <ToolsPublicLayout title="Complete Payment" activeNav="explore">
            <div className="max-w-3xl mx-auto py-16 px-4 sm:px-6">
                <Card className="border-slate-200 shadow-lg overflow-hidden border-t-4 border-t-emerald-500">
                    <CardContent className="p-8 sm:p-12 text-center">
                        <div className="inline-flex items-center justify-center p-4 bg-emerald-100 rounded-full text-emerald-600 mb-6">
                        ...
                        <div className="space-y-4 max-w-md mx-auto">
                            ...
                            <p className="text-sm text-slate-500">
                                You will be redirected to our secure login portal.
                            </p>
                        </div>
                    </CardContent>
                </Card>
