...
export default function MyJobs({ auth, jobs }) {
    ...
    return (
        <FreelanceLayout>
            <Head title="My Posted Jobs" />

            <PageHeader
                title="My Posted Jobs"
                subtitle="Manage and track progress on every freelance opportunity you have published."
                icon={Briefcase}
                actions={
                    <Link 
            ...
            {displayJobs.length === 0 ? (
                <SectionCard>
                    <EmptyState
                        ...
                        description="Get started by publishing your first job opportunity to hire premium experts."
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-slate-500">
                                                ...
                                                <span className="flex items-center gap-1 font-medium">
                                                    ...
                                                    <strong className="text-slate-700 font-bold">{job.proposals_count || 0}</strong> Proposals Received
                                                </span>
                                            </div>
                                        </div>
