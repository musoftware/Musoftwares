...
export default function PaymentGatewayAuditor() {
    useEffect(() => {
        window.location.href = "https://tools.musoftwares.com/tools/payment-gateway-auditor";
    }, []);

    return (
        <PublicLayout>
            <SeoHead title={__('tools.pay_audit_title')} description={__('tools.pay_audit_desc')} />
