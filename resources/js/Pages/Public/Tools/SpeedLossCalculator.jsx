...
export default function SpeedLossCalculator() {
    useEffect(() => {
        window.location.href = "https://tools.musoftwares.com/tools/speed-loss-calculator";
    }, []);

    return (
        <PublicLayout>
            <SeoHead title={__('tools.speed_loss_title')} description={__('tools.speed_loss_desc')} />
