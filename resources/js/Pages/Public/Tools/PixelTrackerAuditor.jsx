...
export default function PixelTrackerAuditor() {
    useEffect(() => {
        window.location.href = "https://tools.musoftwares.com/tools/pixel-tracker-auditor";
    }, []);

    return (
        <PublicLayout>
            <SeoHead title={__('tools.pixel_title')} description={__('tools.pixel_desc')} />
