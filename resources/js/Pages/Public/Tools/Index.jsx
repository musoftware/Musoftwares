...
export default function Index() {
    useEffect(() => {
        window.location.href = "https://tools.musoftwares.com/tools";
    }, []);

    return (
        <PublicLayout>
            <SeoHead title={__('tools.tools_directory') || 'Free Tools'} description={__('tools.tools_directory_desc')} />
            <div className="min-h-[60vh] flex flex-col items-center justify-center bg-[#fcfcfc] text-[#111111] pt-24 pb-16">
                ...
                <h2 className="text-xl font-bold tracking-tight mb-2">جاري توجيهك إلى منصة الأدوات...</h2>
