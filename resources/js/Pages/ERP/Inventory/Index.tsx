    ...
    <ERPLayout title={t('erp.inventory', 'Inventory')} workspaceName={workspaceName} tenantId={tenantId} menuItems={menuItems} lockedAddons={lockedAddons}>
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="mb-6 flex flex-col sm:flex-row items-center justify-end gap-4 gap-4">
                        <h3 className="me-auto text-2xl font-semibold text-gray-900 w-full sm:w-auto">
                                            ...
                                            <div className="flex justify-end gap-4 items-start">
                                                ...
                                                <div className="text-end">
                                                    ...
                                                    <div className="flex justify-end gap-4 items-center text-sm">
                                                        <span className="me-auto text-gray-500">{t('erp.stock', 'Stock')}:</span>
