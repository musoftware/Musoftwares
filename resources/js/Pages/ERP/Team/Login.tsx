                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <Input
                                ...
                                className="h-10 px-3 py-2 pe-10 text-sm rounded-lg border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/50 focus-visible:ring-2 focus-visible:ring-indigo-500 dark:focus-visible:ring-indigo-400 transition-all font-normal"
                            />
                            <button
                                type="button"
