    ...
    return (
        ...
        >
            ...
            <ConfirmModal
                ...
                title={__('general.delete_client')}
            ...
            <ConfirmModal
                ...
                title={__('general.delete_expense')}
            ...
            />
                        ...
                        {currentSection === 'overview' && (
                            <div className="space-y-10">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                    <div>
                                        <h2 className="text-2xl font-semibold text-slate-900 tracking-tight">{__('general.overview')}</h2>
                                        <p className="text-sm text-slate-500 mt-1">{__('general.here_s_what_s_happening_in_your_workspace_today')}</p>
                                    </div>
                                    {!isReadOnlyMember && (
                                ...
                                {!isReadOnlyMember && (
                                    <div className="sm:hidden space-y-3">
                                        <h3 className="text-xs uppercase tracking-widest font-bold text-slate-400 px-1">{__('general.quick_actions')}</h3>
                                        <div className="grid grid-cols-2 gap-3">
                                            <Link href={route('erp.invoices.create')} className="flex flex-col items-center justify-center p-4 bg-white border border-slate-100 rounded-2xl shadow-sm active:scale-95 transition-all">
                                                ...
                                                <span className="text-xs font-medium text-slate-700">{__('general.new_invoice')}</span>
                                            </Link>
                                            ...
                                            <Link href={route("erp.clients.create")} className="flex flex-col items-center justify-center p-4 bg-white border border-slate-100 rounded-2xl shadow-sm active:scale-95 transition-all">
                                                ...
                                                <span className="text-xs font-medium text-slate-700">{__('general.add_client')}</span>
                                            </Link>
                                            ...
                                            <Link href={route("erp.projects.create")} className="flex flex-col items-center justify-center p-4 bg-white border border-slate-100 rounded-2xl shadow-sm active:scale-95 transition-all">
                                                ...
                                                <span className="text-xs font-medium text-slate-700">{__('general.new_project')}</span>
                                            </Link>
                                            )}
                                            ...
                                            <button onClick={() => handleSetSection('tasks')} className="flex flex-col items-center justify-center p-4 bg-white border border-slate-100 rounded-2xl shadow-sm active:scale-95 transition-all">
                                                ...
                                                <span className="text-xs font-medium text-slate-700">{__('general.assign_task')}</span>
                                            </button>
                                            )}
                                        </div>
                                    </div>
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                                    ...
                                    <MetricCard 
                                        label={__('general.active_clients')}
                                        value={activeClients.length}
                                        icon={Users}
                                    />
                                    <MetricCard 
                                        label={__('general.subscriptions')}
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                                        ...
                                        <OperationalCard title={__('general.recent_invoices')} noPadding action={<button onClick={() => handleSetSection('invoices')} className="text-sm text-primary hover:underline transition-colors py-2 px-3 -me-3 sm:py-0 sm:px-0 sm:me-0">{__('general.view_all_1')}</button>}>
                                            <div className="divide-y divide-border/40">
                                                {activeInvoices.length === 0 ? (
                                                    <EmptyState 
                                                        icon={FileText}
                                                        title={__('general.no_recent_invoices')}
                                                    />
                                                ) : (
                                    ...
                                    <div className="space-y-6 sm:space-y-8">
                                        ...
                                        <div className="hidden sm:block">
                                            <h3 className="text-sm font-semibold text-slate-900 mb-4">{__('general.quick_actions')}</h3>
                                            <div className="space-y-2">
                                                    ...
                                                    <>
                                                        <Link href={route("erp.clients.create")} className="w-full flex items-center justify-between p-3 rounded-xl border border-slate-100 bg-white hover:border-slate-300 hover:shadow-sm active:scale-[0.99] transition-all group">
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <span className="font-medium text-slate-700 text-sm">{__('general.add_client')}</span>
                                                            </div>
                                                        ...
                                                        <Link href={route("erp.projects.create")} className="w-full flex items-center justify-between p-3 rounded-xl border border-slate-100 bg-white hover:border-slate-300 hover:shadow-sm active:scale-[0.99] transition-all group">
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <span className="font-medium text-slate-700 text-sm">{__('general.create_project')}</span>
                                                            </div>
                                                            <ChevronRight className="h-4 w-4 text-slate-400 group-hover:text-slate-600 transition-colors" />
                                                        </Link>
                                                        )}
                                                ...
                                                <button onClick={() => handleSetSection('tasks')} className="w-full flex items-center justify-between p-3 rounded-xl border border-slate-100 bg-white hover:border-slate-300 hover:shadow-sm active:scale-[0.99] transition-all text-start group">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <span className="font-medium text-slate-700 text-sm">{__('general.assign_task')}</span>
                                                    </div>
                                                    <ChevronRight className="h-4 w-4 text-slate-400 group-hover:text-slate-600 transition-colors" />
                                                </button>
                                                )}
                                        ...
                                        {/* Recent Activity */}
                                        <div>
                                            <h3 className="text-sm font-semibold text-slate-900 mb-4">{__('general.recent_activity')}</h3>
                                        ...
                                        <table className="w-full text-start text-sm border-collapse">
                                            <thead>
                                                <tr className="bg-slate-50 border-b border-slate-100 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                                                    ...
                                                    <th className="px-6 py-3.5">{__('general.contact')}</th>
                                                    <th className="px-6 py-3.5 text-end">{__('general.balance')}</th>
                                                    <th className="px-6 py-3.5 text-end">{__('general.unpaid')}</th>
                                                    <th className="px-6 py-3.5 text-end">{__('general.paid')}</th>
                                                    <th className="px-6 py-3.5">{__('general.created')}</th>
                                                    {!isReadOnlyMember && <th className="px-6 py-3.5 text-end">{__('general.actions')}</th>}
                                                </tr>
                                            </thead>
                                                ...
                                                {activeClients.length === 0 ? (
                                                    <tr>
                                                        <td colSpan={isReadOnlyMember ? 6 : 7} className="p-0">
                                                            <EmptyState 
                                                                icon={Users} 
                                                                title={__('general.no_clients')} 
                                                                description={__('general.add_your_first_client_to_start_managing_invoices_and_projects')}
                                                            />
                                                        </td>
                                                    </tr>
                                                ) : (
                        ...
                        {currentSection === 'branches' && hasMultiBranch && (
                            <div className="space-y-6">
                                ...
                                {branches && branches.length > 0 ? (
                                            ...
                                            <OperationalCard key={branch.id}>
                                                <div className="p-4 sm:p-5 space-y-4">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-3 bg-slate-50/50 p-3 rounded-lg border border-slate-100">
                                                        <div>
                                                            <span className="block text-[10px] uppercase font-bold text-slate-400 tracking-wider">{__('general.timezone')}</span>
                                                            <span className="block text-[13px] font-semibold text-slate-700 mt-0.5">
                                                                {branch.timezone}
                                                            </span>
                                                        </div>
                                                        <div>
                                                            <span className="block text-[10px] uppercase font-bold text-slate-400 tracking-wider">{__('general.created')}</span>
                                    ...
                                    <EmptyState 
                                        icon={Building2}
                                        title={__('general.no_branches_found')}
                                        description={__('general.you_haven_t_added_any_secondary_branches_to_your_workspace_yet')}
                                ...
                                <Dialog open={showAddBranchModal} onOpenChange={setShowAddBranchModal}>
                                    <DialogContent className="sm:max-w-[425px]">
                                        <DialogHeader>
                                            <DialogTitle>{__('general.create_new_branch')}</DialogTitle>
                                        </DialogHeader>
                                        <form onSubmit={handleAddBranch} className="space-y-4 pt-4">
                                            <div className="space-y-2">
                                                <label className="text-sm font-medium text-slate-700">{__('general.branch_name')}</label>
                                                <Input
                                                    required
                                                    value={branchForm.name}
                                                    onChange={(e) => setBranchForm({ ...branchForm, name: e.target.value })}
                                                    placeholder={__('general.e_g_downtown_office')}
                                                />
                                            </div>
                                            <div className="space-y-2">
                                                <label className="text-sm font-medium text-slate-700">{__('general.branch_type')}</label>
                                                <select
                                                    required
                                                ...
                                                >
                                                    <option value="retail">{__('general.retail_store')}</option>
                                                    <option value="office">{__('general.office')}</option>
                                                    <option value="warehouse">{__('general.warehouse')}</option>
                                                    <option value="virtual">{__('general.virtual_online')}</option>
                                                </select>
                                            </div>
                                            <div className="space-y-2">
                                                <label className="text-sm font-medium text-slate-700">{__('general.timezone')}</label>
                                                <Input
                                                    value={branchForm.timezone}
                                                    onChange={(e) => setBranchForm({ ...branchForm, timezone: e.target.value })}
                                                    placeholder={__('general.e_g_utc')}
                                                />
                                            </div>
                                            <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
                                                <Button type="button" variant="outline" onClick={() => setShowAddBranchModal(false)}>
                                                    {__('general.cancel')}</Button>
                                                <Button type="submit">{__('general.create_branch')}</Button>
                                            </div>
                                        </form>
                                    </DialogContent>
                                </Dialog>
                                    ...
                                    {projects.map((proj) => (
                                        <OperationalCard key={proj.id}>
                                            <div className="p-4 sm:p-5 space-y-4">
                                                ...
                                                <div className="grid grid-cols-2 gap-3 bg-slate-50/50 p-3 rounded-lg border border-slate-100">
                                                    <div>
                                                        <span className="block text-[10px] uppercase font-bold text-slate-400 tracking-wider">{__('general.budget')}</span>
                                                        <span className="block text-[13px] font-semibold text-slate-700 mt-0.5">
                                                            <CurrencyDisplay amount={proj.budget} currency={proj.currency || currency} />
                                                        </span>
                                                    </div>
                                                    <div>
                                                        <span className="block text-[10px] uppercase font-bold text-slate-400 tracking-wider">{__('general.deadline')}</span>
                                                        <span className="block text-[13px] font-semibold text-slate-700 mt-0.5 flex items-center gap-1.5">
                                                            <CalendarIcon className="h-3.5 w-3.5 text-slate-400 shrink-0" />
                                                ...
                                                {!isReadOnlyMember && (
                                                    <div className="pt-3 sm:pt-4 border-t border-slate-100 flex items-center gap-2">
                                                        ...
                                                        >
                                                            <Edit2 className="h-3.5 w-3.5" /> {__('general.edit')}</Link>
                                                        <button 
                            ...
                            <div className="space-y-6">
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                    <div className="flex-grow">
                                        <ModulePageHeader 
                                            title={__('general.tasks')} 
                                            description={__('general.manage_and_organize_your_team_s_tasks_and_priorities')}
                                        />
                                    </div>
                                    <div className="w-full sm:w-[240px] flex flex-col gap-1.5 mt-2">
                                        <label className="text-[10px] uppercase font-bold tracking-wider text-slate-400">{__('general.filter_tasks_by_client')}</label>
                                        <AsyncCombobox
                                            ...
                                            placeholder={__('general.select_client_to_filter')}
                                            ...
                                            <div key={lane} className="bg-slate-50/80 border border-slate-200/60 p-3.5 rounded-xl space-y-4">
                                                ...
                                                <div className="pt-2">
                                                    <div className="flex gap-1.5">
                                                        <Input 
                                                            placeholder={__('general.add_task')} 
                                ...
                                <OperationalCard>
                                    <div className="overflow-x-auto">
                                        <table className="w-full text-start text-sm border-collapse">
                                            <thead>
                                                <tr className="bg-slate-50 border-b border-slate-100 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                                                    <th className="px-6 py-3.5">{__('general.filename')}</th>
                                                    <th className="px-6 py-3.5">{__('general.storage_provider')}</th>
                                                    <th className="px-6 py-3.5">{__('general.tags')}</th>
                                                    <th className="px-6 py-3.5">{__('general.file_size')}</th>
                                                    <th className="px-6 py-3.5 text-end">{__('general.access')}</th>
                                                </tr>
                                            </thead>
                                            <tbody className="divide-y divide-slate-100">
                                                {documents.map((doc) => (
                                        ...
                                        <table className="w-full text-start text-sm border-collapse">
                                            <thead>
                                                <tr className="bg-slate-50 border-b border-slate-100 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                                                    ...
                                                    <th className="px-6 py-3.5 text-end">{__('general.value')}</th>
                                                    <th className="px-6 py-3.5 text-center">{__('general.status')}</th>
                        ...
                        {currentSection === 'transactions' && (
                            <div className="space-y-6">
                                <ModulePageHeader 
                                    title={__('general.transactions')} 
                                    description={__('general.view_all_wallet_activity_payments_and_balance_adjustments')}
                                ...
                                <OperationalCard noPadding>
                                    <div className="overflow-x-auto">
                                        <table className="w-full text-start text-sm border-collapse">
                                            <thead>
                                                <tr className="bg-slate-50 border-b border-slate-100 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                                                    <th className="px-5 py-3.5">{__('general.reference')}</th>
                                                    <th className="px-5 py-3.5">{__('general.client')}</th>
                                                    <th className="px-5 py-3.5">{__('general.type')}</th>
                                                    <th className="px-5 py-3.5 text-center">{__('general.direction')}</th>
                                                    <th className="px-5 py-3.5 text-end">{__('general.amount')}</th>
                                                    <th className="px-5 py-3.5 text-end">{__('general.balance')}</th>
                                                    <th className="px-5 py-3.5">{__('general.authorized_by')}</th>
                                                    <th className="px-5 py-3.5 text-end">{__('general.timestamp')}</th>
                                                </tr>
                                            </thead>
                                            <tbody className="divide-y divide-slate-100">
                                                {filteredTransactions.length === 0 ? (
                                                    <tr>
                                                        <td colSpan={8} className="p-0">
                                                            <EmptyState
                                                                icon={History}
                                                                title={__('general.no_transactions_found_1')}
                                                            ...
                                                            <td className="px-5 py-4 text-center">
                                                                {txn.direction === 'CREDIT' ? (
                                                                    <Badge className="bg-emerald-50 text-emerald-700 border-none rounded font-bold text-[10px]">
                                                                        <ArrowDown className="h-3 w-3 me-0.5" /> {__('general.credit')}</Badge>
                                                                ) : (
                                                                    <Badge className="bg-rose-50 text-rose-700 border-none rounded font-bold text-[10px]">
                                                                        <ArrowUp className="h-3 w-3 me-0.5" /> {__('general.debit')}</Badge>
                                                                )}
                                                            </td>
                                ...
                                <OperationalCard>
                                    <div className="overflow-x-auto">
                                        <table className="w-full text-start text-sm border-collapse">
                                            <thead>
                                                <tr className="bg-slate-50 border-b border-slate-100 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                                                    <th className="px-6 py-3.5">{__('general.expense')}</th>
                                                    <th className="px-6 py-3.5">{__('general.category')}</th>
                                                    <th className="px-6 py-3.5 text-end">{__('general.amount')}</th>
                                                    <th className="px-6 py-3.5">{__('general.date')}</th>
                                                    {!isReadOnlyMember && <th className="px-6 py-3.5 text-end">{__('general.actions')}</th>}
                                                </tr>
                                            </thead>
                                            <tbody className="divide-y divide-slate-100">
                                                {expenses.length === 0 ? (
                                                    <tr>
                                                        <td colSpan={isReadOnlyMember ? 4 : 5} className="p-0">
                                                            <EmptyState 
                                                                icon={Receipt} 
                                                                title={__('general.no_expenses')} 
                                                                description={__('general.log_your_first_business_expense_to_track_workspace_costs')}
                                                            />
                                                        </td>
                                                    </tr>
                                                ) : (
                                                    expenses.map((exp) => (
                                                        <tr key={exp.id} className="hover:bg-slate-50 transition text-[13px] text-slate-700">
                                                            <td className="px-6 py-4" data-label={__('general.expense')}>
                                                            ...
                                                            <td className="px-6 py-4" data-label={__('general.category')}>
                                                                <Badge variant="outline" className="text-[10px] font-medium text-slate-500 bg-white shadow-none rounded-md">
                                                                    {exp.category}
                                                                </Badge>
                                                            </td>
                                                            <td className="px-6 py-4 text-end font-semibold text-slate-900 font-mono" data-label={__('general.amount')}>
                                                                <CurrencyDisplay amount={exp.amount} currency={currency} />
                                                            </td>
                                                            <td className="px-6 py-4 text-slate-500 text-xs font-mono" data-label={__('general.date')}>
                                                                {formatDate(exp.date)}
                                                            </td>
                                                            {!isReadOnlyMember && (
                                                                <td className="px-6 py-4 text-end" data-label={__('general.actions')}>
                        ...
                        {currentSection === 'team' && (
                            <div className="space-y-6">
                                <ModulePageHeader 
                                    title={__('general.team')} 
                                    description={__('general.manage_your_team_members_and_their_workspace_access')}
                                />
                                    ...
                                    <div className="lg:col-span-6 space-y-6">
                                        <OperationalCard>
                                            <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
                                                <h3 className="font-semibold text-slate-800 text-[14px]">{__('general.teammates_directory')}</h3>
                                                <Badge className="bg-indigo-50 text-indigo-700 border-none font-bold text-[10px]">{__('general.active_workspace')}</Badge>
                                            </div>
                                        ...
                                        <OperationalCard>
                                            <div className="p-5 space-y-4">
                                                <h4 className="font-semibold text-slate-800 text-[13px] flex items-center gap-1.5">
                                                    <Sliders className="h-4 w-4 text-indigo-600" />{__('general.granular_role_matrix')}</h4>
                                                <p className="text-xs text-slate-500 leading-relaxed">{__('general.configure_read_write_gates_across_the_modules_owner_maintains_central_ledger_access')}</p>
                                                ...
                                                <div className="space-y-3 pt-3 border-t border-slate-100 text-xs text-slate-700">
                                                    <div className="flex justify-between font-semibold border-b pb-1">
                                                        <span>{__('general.module_scope')}</span>
                                                        <span>{__('general.min_required_role')}</span>
                                                    </div>
                                                    <div className="flex justify-between">
                                                        <span>{__('general.central_ledger')}</span>
                                                        <Badge variant="outline" className="text-[10px] font-bold">{__('general.owner')}</Badge>
                                                    </div>
                                                    <div className="flex justify-between">
                                                        <span>{__('general.invoice_generation')}</span>
                                                        <Badge variant="outline" className="text-[10px] font-bold">{__('general.accountant')}</Badge>
                                                    </div>
                                                    <div className="flex justify-between">
                                                        <span>{__('general.task_assignments')}</span>
                                                        <Badge variant="outline" className="text-[10px] font-bold">{__('general.staff')}</Badge>
                                                    </div>
                                                </div>
                                            </div>
                                        </OperationalCard>
                                    ...
                                    <div className="lg:col-span-6">
                                        {selectedNote ? (
                                            <OperationalCard className="p-6 space-y-4">
                                                <div className="flex items-center justify-between border-b pb-4">
                                                    <div className="flex items-center gap-3 w-full">
                                                        ...
                                                        >
                                                            <option value="Internal">{__('general.internal')}</option>
                                                        ...
                                                        <Input 
                                                            ...
                                                            placeholder={__('general.note_title_1')}
                                                ...
                                                <Textarea 
                                                    ...
                                                    placeholder={__('general.start_typing_your_note_here')}
                                            ...
                                            <div className="h-full bg-slate-50 border border-slate-200 border-dashed rounded-xl flex flex-col items-center justify-center p-8 text-center text-slate-400">
                                                ...
                                                <p className="text-xs">{__('general.select_a_note_from_the_left_to_start_editing')}</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                            ...
                            return (
                                <div className="space-y-6">
                                    <ModulePageHeader 
                                        ...
                                        description={__('general.view_task_due_dates_client_deliverables_and_scheduling_timelines')}
                                    />
                                        ...
                                        <div className="lg:col-span-3 space-y-6">
                                            ...
                                            <OperationalCard>
                                                <div className="p-4 border-b border-slate-100 flex items-center justify-between">
                                                    <h4 className="font-bold text-slate-800 text-[13px] flex items-center gap-1.5">
                                                        <Clock className="h-4 w-4 text-indigo-500" />{__('general.upcoming_schedule')}</h4>
                                                    <Badge className="bg-indigo-50 text-indigo-700 font-bold border-none text-[9px] uppercase tracking-wider rounded">{__('general.next_7_days')}</Badge>
                                                </div>
                                                <div className="p-3 divide-y divide-slate-100">
                                                    {upcomingCalendarTasks.length === 0 ? (
                                                        <div className="text-center py-6 text-xs text-slate-400">{__('general.no_tasks_due_this_week')}</div>
                                                    ) : (
                                            ...
                                            <OperationalCard>
                                                <div className="p-4 border-b border-slate-100">
                                                    <h4 className="font-bold text-slate-800 text-[13px] flex items-center gap-1.5">
                                                        <AlertCircle className="h-4 w-4 text-amber-500" />{__('general.needs_date_assignment')}</h4>
                                                </div>
                                                <div className="p-3 divide-y divide-slate-100 max-h-[220px] overflow-y-auto">
                                                    {unscheduledCalendarTasks.length === 0 ? (
                                                        <div className="text-center py-6 text-xs text-slate-400">{__('general.all_tasks_scheduled')}</div>
                                                    ) : (
                                            ...
                                            {!isReadOnlyMember && (
                                                <OperationalCard>
                                                    <div className="p-4 border-b border-slate-100">
                                                        <h4 className="font-bold text-slate-800 text-[13px] flex items-center gap-1.5">
                                                            <Plus className="h-4 w-4 text-indigo-500" />{__('general.quick_add_task')}</h4>
                                                    </div>
                                                    <form onSubmit={(e) => {
                                                        e.preventDefault();
                                                        ...
                                                        <div>
                                                            ...
                                                            <Input 
                                                                placeholder={__('general.e_g_design_wireframes')}
                                                        ...
                                                        <div>
                                                            <label className="text-[10px] uppercase font-bold tracking-wider text-slate-400 block mb-1">{__('general.assign_client')}</label>
                                                            <AsyncCombobox
                                                                endpoint={route('erp.clients.search')}
                                                        ...
                                                        <div className="grid grid-cols-2 gap-2">
                                                            <div>
                                                                <label className="text-[10px] uppercase font-bold tracking-wider text-slate-400 block mb-1">{__('general.priority')}</label>
                                                                <select
                                                            ...
                                                            <div>
                                                                <label className="text-[10px] uppercase font-bold tracking-wider text-slate-400 block mb-1">{__('general.status')}</label>
                                                                <select
                                                                    value={calendarTaskForm.status}
                                                                    onChange={e => setCalendarTaskForm(prev => ({ ...prev, status: e.target.value }))}
                                                                    className="w-full text-xs h-8.5 rounded-md border border-slate-200 bg-white px-2.5 shadow-none focus:outline-none"
                                                                >
                                                                    <option value="open">{__('general.todo')}</option>
                                                                    <option value="in_progress">{__('general.in_progress')}</option>
                                                                    <option value="review">{__('general.in_review')}</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <Button type="submit" size="sm" className="w-full shadow-none text-xs font-semibold h-8.5 mt-1 bg-indigo-600 text-white hover:bg-indigo-700 transition-colors">{__('general.add_for_today')}</Button>
                                                    </form>
                                                </OperationalCard>
                                            )}
                                        </div>
                                        ...
                                        <table className="w-full text-start text-sm border-collapse">
                                            <thead>
                                                <tr className="bg-slate-50 border-b border-slate-100 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                                                    ...
                                                    <th className="px-6 py-3.5">{__('general.ticket_subject')}</th>
                                                    <th className="px-6 py-3.5">{__('general.client_tenant')}</th>
                        ...
                        {currentSection === 'activity' && (
                            <div className="space-y-6">
                                <ModulePageHeader 
                                    title={__('general.activity')} 
                                    description={__('general.log_of_actions_taken_within_the_workspace')}
                                />
                        ...
                        {currentSection === 'settings' && (
                            <div className="space-y-6">
                                <ModulePageHeader 
                                    ...
                                    description={__('general.manage_your_workspace_preferences_billing_parameters_and_brand_identity')}
                                />
                                ...
                                <OperationalCard>
                                    <div className="p-6 space-y-6">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div className="space-y-2">
                                                <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider block">{__('general.workspace_brand_name')}</label>
                                                <Input 
                                        ...
                                        <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                                            <div className="flex gap-2 text-slate-500 text-xs font-medium">
                                                <CheckCircle2 className="h-4 w-4 text-emerald-500" />{__('general.workspace_settings_live_audited_under_pci_protocols')}</div>
                                            <Button size="sm" className="shadow-none" onClick={handleUpdateSettings}>{__('general.save_settings')}</Button>
                                        </div>
                                    </div>
                                </OperationalCard>
                                ...
                                <OperationalCard>
                                    <div className="p-6 border-b border-slate-100 flex items-center justify-between">
                                        <div>
                                            <h3 className="font-semibold text-slate-900 text-sm">{__('general.storage_integrations')}</h3>
                                                ...
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            {provider.isDefault && <Badge variant="secondary" className="text-[9px] uppercase tracking-wider bg-indigo-50 text-indigo-700">{__('general.default')}</Badge>}
                                                        </div>
                                ...
                                {selectedCalendarTask && (
                                    <div className="space-y-4 text-start">
                                        ...
                                        <div className="space-y-3.5 text-xs text-slate-700">
                                            {selectedCalendarTask.client && (
                                                <div className="flex justify-between items-center py-1.5 border-b border-slate-50">
                                                    <span className="font-semibold text-slate-400 uppercase tracking-wider text-[10px]">{__('general.client')}</span>
                                            ...
                                            <div className="flex justify-between items-center py-1.5 border-b border-slate-50">
                                                <span className="font-semibold text-slate-400 uppercase tracking-wider text-[10px]">{__('general.priority')}</span>
                                            ...
                                            <div className="flex justify-between items-center py-1.5 border-b border-slate-50">
                                                <span className="font-semibold text-slate-400 uppercase tracking-wider text-[10px]">{__('general.due_date')}</span>
                                            ...
                                            <div className="flex justify-between items-center py-1.5 border-b border-slate-50">
                                                <span className="font-semibold text-slate-400 uppercase tracking-wider text-[10px]">{__('general.assignee')}</span>
                                            ...
                                            {selectedCalendarTask.task_description && (
                                                <div className="space-y-1.5 pt-2">
                                                    <span className="font-semibold text-slate-400 uppercase tracking-wider text-[10px] block font-sans">{__('general.description')}</span>
                                        ...
                                        <div className="pt-4 border-t border-slate-100 flex items-center justify-end gap-4 gap-3">
                                            ...
                                            >
                                                <ArrowUpRight className="h-4 w-4" />{__('general.go_to_board')}</Link>
                                            <Button 
                            ...
                            <DialogContent className="sm:max-w-md p-6 rounded-2xl border-none shadow-xl bg-white text-start">
                                <DialogHeader className="pb-2 border-b border-slate-100">
                                    <DialogTitle className="text-base font-bold text-slate-900 flex items-center gap-2">
                                        ...
                                        <span>{__('general.add_task_on_calendar')}</span>
                                    </DialogTitle>
                                ...
                                <form onSubmit={handleCalendarAddTask} className="space-y-4 pt-2">
                                    <div className="space-y-1">
                                        <label className="text-[10px] uppercase font-bold tracking-wider text-slate-400">{__('general.task_title')}</label>
                                        <Input 
                                            placeholder={__('general.e_g_design_homepage_wireframes')}
                                            value={calendarTaskForm.title}
                                            onChange={e => setCalendarTaskForm(prev => ({ ...prev, title: e.target.value }))}
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-[10px] uppercase font-bold tracking-wider text-slate-400">{__('general.assign_client')}</label>
                                        <AsyncCombobox
                                            endpoint={route('erp.clients.search')}
                                            value={calendarTaskForm.client_id}
                                            onChange={(val) => setCalendarTaskForm(prev => ({ ...prev, client_id: val ? val.toString() : '' }))}
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <div className="space-y-1">
                                            <label className="text-[10px] uppercase font-bold tracking-wider text-slate-400">{__('general.priority')}</label>
                                            <select
                                                value={calendarTaskForm.priority}
                                                onChange={e => setCalendarTaskForm(prev => ({ ...prev, priority: e.target.value }))}
                                        ...
                                        <div className="space-y-1">
                                            <label className="text-[10px] uppercase font-bold tracking-wider text-slate-400">{__('general.status')}</label>
                                            <select
                                                value={calendarTaskForm.status}
                                                onChange={e => setCalendarTaskForm(prev => ({ ...prev, status: e.target.value }))}
                                                className="w-full text-xs h-9.5 rounded-md border border-slate-200 bg-white px-2.5 shadow-none focus:outline-none"
                                            >
                                                ...
                                                <option value="in_progress">{__('general.in_progress')}</option>
                                                <option value="review">{__('general.in_review')}</option>
                                                <option value="completed">{__('general.done')}</option>
                                            </select>
                                        </div>
                                    </div>

                                    <div className="space-y-1">
                                        <label className="text-[10px] uppercase font-bold tracking-wider text-slate-400">{__('general.description')}</label>
                                        <Textarea 
                                            placeholder={__('general.enter_additional_task_details_and_guidelines')}
                                    ...
                                    <div className="pt-4 border-t border-slate-100 flex items-center justify-end gap-2.5">
                                        ...
                                        >{__('general.schedule_task')}</Button>
                                    </div>
                                </form>
                            </DialogContent>
                        </Dialog>
