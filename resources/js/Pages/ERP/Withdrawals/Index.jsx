...
export default function IndexAdmin({ auth, withdrawals }) {
    ...
    return (
        <ERPLayout title={__('erp.payouts')} workspaceName={workspaceName} tenantId={tenantId} menuItems={menuItems} lockedAddons={lockedAddons}>
                            ...
                            {actionModal.type === 'reject' ? (
                                <form onSubmit={handleReject}>
                                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                        <h3 className="text-lg leading-6 font-medium text-gray-900">{__('erp.reject_payout')}</h3>
                                        <div className="mt-2">
                                            <textarea
