                            ...
                            <div className="space-y-4 animate-in fade-in slide-in-from-right-3 duration-300">
                                ...
                                <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
                                    ...
                                    {campaignLeads.length > 0 && (
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-5">
                                            ...
                                            <StatCard label="With Email" value={campaignLeads.filter(l => l.email).length} icon={Mail} />
                                        </div>
                                    )}
                                </div>
                                ...
                                {!loadingDetail && campaignLeads.length === 0 && (
                                    <div className="py-16 text-center bg-white border border-dashed border-slate-200 rounded-2xl">
                                        ...
                                        <p className="text-sm text-slate-500 font-medium">No leads in this campaign</p>
                                    </div>
                                )}
                            </div>
                        ) : (
