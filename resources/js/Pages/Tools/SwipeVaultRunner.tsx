...
export default function SwipeVaultRunner({ tool }: any) {
    return (
        <div className="min-h-screen bg-slate-950 font-sans text-slate-100 flex flex-col items-center justify-center p-8">
            <div className="max-w-md text-center space-y-6">
                ...
                <h1 className="text-2xl font-bold">Swipe Vault</h1>
                <p className="text-sm text-slate-400">
                    Save and organize creative inspiration automatically via the local runtime.
                </p>
