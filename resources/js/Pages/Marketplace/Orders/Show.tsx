        ...
        <MarketplaceLayout>
            ...
            <div className="min-h-screen bg-gray-50 dark:bg-[#090d16] py-8">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    {/* Top Status Bar */}
                    <div className="mb-8 rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#0f172a] p-6 shadow-sm">
                        ...
                        <div className="relative">
                            <div className="mb-4 flex h-2 overflow-hidden rounded bg-gray-200 dark:bg-white/10 text-xs">
                                <div
                                    style={{
                            ...
                            <div className="flex justify-between px-1 text-xs font-medium text-gray-500 dark:text-slate-400">
                                <div
                                    className={`text-start ${currentStepIndex >= 0 ? 'font-bold text-indigo-600 dark:text-indigo-400' : ''}`}
                                >
                                    {__('general.placed')}</div>
                                <div
                                    className={`text-center ${currentStepIndex >= 1 ? 'font-bold text-indigo-600 dark:text-indigo-400' : ''}`}
                                >{__('general.in_progress')}</div>
                                <div
                                    className={`text-center ${currentStepIndex >= 2 ? 'font-bold text-indigo-600 dark:text-indigo-400' : ''}`}
                                >
                                    {__('general.delivered')}</div>
                                <div
                                    className={`text-end ${currentStepIndex >= 3 ? 'font-bold text-indigo-600 dark:text-indigo-400' : ''}`}
                                >
                    ...
                    <div className="flex flex-col gap-8 lg:flex-row">
                        ...
                        <div className="flex w-full flex-col gap-8 lg:w-3/5">
                            {/* Requirements Note */}
                            <div className="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#0f172a] p-6 shadow-sm">
                                ...
                                <div className="rounded-lg border border-gray-100 dark:border-white/10 bg-gray-50 dark:bg-white/[0.03] p-4 text-sm text-gray-700 dark:text-slate-300">
                                    <p>
                            ...
                            {order.status === 'delivered' && (
                                <div className="relative overflow-hidden rounded-xl border border-indigo-200 dark:border-indigo-500/30 bg-white dark:bg-[#0f172a] p-6 shadow-sm">
                                    ...
                                    {order.delivery_payload?.serial_code && (
                                        <div className="mb-6 rounded-xl border border-emerald-200 dark:border-emerald-500/30 bg-emerald-50/60 dark:bg-emerald-950/20 p-4 space-y-3 shadow-xs">
                                            <div className="flex items-center justify-between">
                                                <h5 className="text-xs font-bold uppercase text-emerald-900 dark:text-emerald-300 tracking-wider flex items-center gap-2">
                                    ...
                                    {isBuyer && (
                                        <div className="flex gap-4 border-t border-gray-100 dark:border-white/10 pt-6">
                                            <button
                            ...
                            <div className="flex h-[600px] flex-col rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#0f172a] shadow-sm">
                                <div className="flex items-center justify-between rounded-t-xl border-b border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-slate-900/50 p-4">
                                    ...
                                    <span className="flex items-center gap-1 rounded-full bg-green-100 dark:bg-green-950/50 px-2 py-1 text-xs font-medium text-green-800 dark:text-green-300">
                                        <span className="h-2 w-2 animate-pulse rounded-full bg-green-500"></span>{__('general.real_time_active')}</span>
                                </div>

                                <div className="flex flex-1 flex-col gap-4 overflow-y-auto bg-gray-50 dark:bg-[#090d16]/70 p-4">
                                    ...
                                    conversation.messages.length > 0 ? (
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <div
                                                                className={`rounded-2xl px-4 py-2.5 ${isMe ? 'rounded-te-none bg-indigo-600 text-white' : 'rounded-ts-none border border-gray-200 dark:border-white/10 bg-white dark:bg-[#1e293b] text-gray-900 dark:text-white shadow-sm'}`}
                                                            >
                                                                <p className="text-sm whitespace-pre-wrap">
                                                                    {msg.body}
                                                                </p>
                                                            </div>
                                                            <span className="mt-1 text-[10px] text-gray-400 dark:text-slate-500">
                                                                {new Date(
                                                                    msg.created_at ||
                                                                        new Date(),
                                                                ).toLocaleTimeString(
                                        ...
                                        <div className="flex flex-1 flex-col items-center justify-center text-gray-500 dark:text-slate-400">
                                            <svg
                                                className="mb-3 h-12 w-12 text-gray-300 dark:text-slate-600"
                                                fill="none"
                                                stroke="currentColor"
                                                viewBox="0 0 24 24"
                                            >
                                ...
                                <div className="rounded-b-xl border-t border-gray-200 dark:border-white/10 bg-white dark:bg-[#0f172a] p-4">
                                    <form
                                        onSubmit={(e) => {
                                            e.preventDefault();
                                            const form =
                        ...
                        <div className="w-full lg:w-2/5">
                            <div className="sticky top-6 flex flex-col gap-6">
                                ...
                                <div className="overflow-hidden rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#0f172a] shadow-sm">
                                    <div className="flex items-center justify-between border-b border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-slate-900/50 p-4">
                                        <h4 className="font-bold text-gray-900 dark:text-white">{__('general.order_details')}</h4>
                                        <span className="rounded bg-gray-200 dark:bg-white/10 px-2 py-1 font-mono text-xs text-gray-500 dark:text-slate-400">
                                            #
                                            {order.id
                                                .toString()
                                                .padStart(6, '0')}
                                    ...
                                    <div className="p-6">
                                        <div className="mb-4 flex items-center justify-between">
                                            ...
                                            <span className="rounded bg-indigo-50 dark:bg-indigo-950/40 px-2 py-0.5 text-sm font-bold text-gray-900 text-indigo-700 dark:text-indigo-300">
                                                {order.package?.name}
                                            </span>
                                        </div>
                                        ...
                                        {(order.status === 'pending' ||
                                            ...
                                            <div
                                                className={`flex items-center justify-between rounded-lg border p-4 ${isOverdue ? 'border-red-200 dark:border-red-500/30 bg-red-50 dark:bg-red-950/30' : 'border-amber-200 dark:border-amber-500/30 bg-amber-50 dark:bg-amber-950/30'}`}
                                            >
                                                <div>
                                                    <h5
                                                        className={`text-sm font-bold ${isOverdue ? 'text-red-700 dark:text-red-400' : 'text-amber-800 dark:text-amber-300'}`}
                                                    >
                                                        {isOverdue
                                                    ...
                                                    <p
                                                        className={`text-xs ${isOverdue ? 'text-red-600 dark:text-red-400' : 'text-amber-700 dark:text-amber-300'}`}
                                                    >
                                                ...
                                                <div
                                                    className={`font-mono text-xl font-bold ${isOverdue ? 'text-red-600 dark:text-red-400' : 'text-amber-600 dark:text-amber-400'}`}
                                                >
                                                    {isOverdue
                                                        ? __('general.late')
                                                        : timeLeftStr}
                                ...
                                {isSeller &&
                                    (order.status === 'pending' ||
                                        order.status === 'in_progress') && (
                                        <div className="overflow-hidden rounded-xl border border-indigo-500 dark:border-indigo-500/40 bg-white dark:bg-[#0f172a] shadow-sm">
                                            <div className="flex items-center gap-2 border-b border-indigo-100 dark:border-indigo-500/20 bg-indigo-50 dark:bg-indigo-950/40 p-4">
                                                <svg
                                                ...
                                                <h4 className="font-bold text-indigo-900 dark:text-indigo-200">{__('general.submit_delivery')}</h4>
                                            </div>
                                            <div className="p-6">
                                                <form onSubmit={handleDeliver}>
                                                    <div className="mb-4">
                                                        <label className="mb-2 block text-sm font-medium text-gray-700 dark:text-slate-300">{__('general.delivery_note')}</label>
                                                        <textarea
                                                            className="w-full rounded-lg border-gray-300 dark:border-white/10 bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-slate-500 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                                            rows={4}
                                                    ...
                                                    <div className="mb-6">
                                                        <label className="mb-2 block text-sm font-medium text-gray-700 dark:text-slate-300">{__('general.upload_files')}</label>
                                                        <div className="cursor-pointer rounded-lg border-2 border-dashed border-gray-300 dark:border-white/10 p-6 text-center transition hover:bg-gray-50 dark:hover:bg-white/[0.02]">
                                                            <svg
                                                                className="mx-auto mb-2 h-8 w-8 text-gray-400 dark:text-slate-500"
                                                                fill="none"
                                                                stroke="currentColor"
                                                                viewBox="0 0 24 24"
                                                            >
                                ...
                                <div className="mt-2 text-center">
                                    <button
                                        ...
                                        className="text-xs text-gray-500 dark:text-slate-400 underline transition hover:text-red-600 dark:hover:text-red-400"
