...
export default function EditService({ categories, service }: Props) {
            ...
            <div className="min-h-screen bg-slate-50">
                ...
                <div className="bg-white border-b border-slate-200 sticky top-0 z-30">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
                        ...
                        <h1 className="text-base font-semibold text-slate-900">{__('general.edit_service')}</h1>
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex items-center gap-2 mb-3">
                                        <div className="w-6 h-6 rounded-full bg-indigo-100 flex items-center justify-center overflow-hidden shrink-0">
                                            {service.seller?.avatar ? <img src={service.seller.avatar} alt={service.seller.name} className="w-full h-full object-cover" /> : <span className="text-[10px] font-bold text-indigo-600">{service.seller?.name?.charAt(0)}</span>}
                                        </div>
                                        <span className="text-xs font-medium text-slate-700 truncate">{service.seller?.name}</span>
