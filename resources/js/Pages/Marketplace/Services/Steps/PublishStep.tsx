        ...
        <div className="max-w-2xl mx-auto space-y-8 py-10">
            <div className="text-center space-y-4">
                ...
                <p className="text-slate-500 max-w-md mx-auto leading-relaxed">
                    You're just one click away from publishing your service. Review your live preview on the right to make sure everything looks perfect.
                </p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mt-8">
                <div className="p-6 bg-slate-50 border-b border-slate-100">
                    <h3 className="font-bold text-slate-900 flex items-center gap-2">
                        <span className="text-xl">📋</span> Final Review Checklist
                    </h3>
                </div>
                <div className="p-6 space-y-4">
                    <div className="flex items-center justify-between py-2 border-b border-dashed border-slate-200">
                        <span className="text-sm font-medium text-slate-600">Title & Category</span>
            ...
            <div className="flex items-start gap-4 bg-amber-50 border border-amber-200/60 rounded-2xl p-5">
                ...
                <div className="text-sm text-amber-800 leading-relaxed">
                    <strong className="block mb-1 font-bold">Review Process</strong>
                    Your service will be manually reviewed by our quality team to ensure it meets marketplace guidelines. You'll be notified within 24 hours once it goes live.
                </div>
            </div>
