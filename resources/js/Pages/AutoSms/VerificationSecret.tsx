                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-slate-500 mt-1">Used to verify that webhook requests actually originated from AutoSMS.</p>
                        </div>
                    ...
                    <Card className="border-indigo-100 shadow-lg shadow-indigo-100/50">
                        <CardHeader className="bg-indigo-50/50 border-b border-indigo-100 pb-8">
                            ...
                            <CardDescription className="text-indigo-700/80">
                                When we send an HTTP POST to your webhook endpoint, we include an <code>X-AutoSMS-Signature</code> header. 
