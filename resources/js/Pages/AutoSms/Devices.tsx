                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-slate-500 mt-1">Manage all Android terminals connected to your AutoSMS gateway.</p>
                        </div>
                                    ...
                                    {devices.map(device => (
                                        <div key={device.id} className="flex flex-col sm:flex-row justify-between p-5 border rounded-xl hover:shadow-md transition-shadow bg-white">
                                            ...
                                            <div className="flex sm:flex-col gap-2 mt-4 sm:mt-0 items-end">
                                                <Button size="sm" variant="outline" className="w-full" onClick={() => router.visit(route('autosms.device', device.id))}>
