...
export default function Verification({ token }: VerificationProps) {
    return (
        <AuthenticatedLayout header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">API Verification</h2>}>
            <Head title="API Authentication - AutoSMS" />
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Your API requests to AutoSMS must be authenticated with a Bearer token.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            {token ? (
                                <div className="p-6 border rounded-xl bg-emerald-50/50 flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-emerald-700 mt-1 text-sm">
                                            ...
                                            when making requests to the AutoSMS gateway API.
                                        </p>
                                ...
                                <Alert className="bg-amber-50 text-amber-800 border-amber-200">
                                    ...
                                    <AlertDescription>
                                        ...
                                        you can programmatically interact with the AutoSMS gateway.
                                    </AlertDescription>
                                </Alert>
                            )}
