...
export default function IntegrationTester({ webhook, token, verificationSecret }: IntegrationTesterProps) {
    ...
    const handleRunTest = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(route('autosms.integration-tester.run'), {
                method: 'POST',
                headers: {
    ...
    return (
        ...
        >
            <Head title="Integration Tester - AutoSMS" />
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-slate-500 mt-1">Simulate API calls to verify your application's handling of AutoSMS payloads.</p>
                        </div>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <Alert className="bg-slate-50 border-slate-200 mt-6">
                                        ...
                                        <AlertDescription className="text-slate-600 font-mono text-xs mt-2 space-y-2">
                                            ...
                                            <p>User-Agent: AutoSMS-Integration-Tester/1.0</p>
