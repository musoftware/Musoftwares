...
import {
  ...
  FileSearch, Info, History, Clock, ChevronRight } from
'lucide-react';
            ...
            <Alert variant="destructive" className="mb-6 animate-in fade-in slide-in-from-top-2 duration-300">
                ...
                "border-slate-200 shadow-sm hover:shadow-md"
                  ...
                  <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                                                ...
                                                <div className="mb-6">
                                                    <div className="flex items-center justify-end gap-4 text-xs text-slate-500 mb-1.5">
                                                        <span className="me-auto">{__('general.match_rate')}</span>
