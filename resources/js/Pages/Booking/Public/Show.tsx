...
export default function Show({ host, eventType }: any) {
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                        ...
                        {eventType.providers.map((prov: any) => {
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <div className="h-10 w-10 rounded-full bg-gradient-to-tr from-indigo-500 to-purple-500 flex items-center justify-center text-white font-semibold text-sm shrink-0">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-xs text-indigo-600 truncate flex items-center">
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`
                                                    ...
                                                    ${isSelected 
                                                        ? 'border-indigo-600 bg-indigo-50/20 text-slate-900 ring-1 ring-indigo-500/30' 
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="pt-4 border-t border-slate-100 mt-6">
                    <Button 
                        type="submit" 
                        disabled={processing} 
                        className="w-full bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl py-6 text-base font-semibold shadow-sm flex items-center justify-center gap-2"
                    >
                        {processing ? (
                            'Processing booking...'
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 py-12 selection:bg-indigo-100">
            ...
            <div className="max-w-5xl w-full bg-white rounded-3xl shadow-[0_8px_40px_rgba(0,0,0,0.03)] overflow-hidden border border-slate-150 flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-80 bg-slate-50/50 p-8 border-r border-slate-100 relative overflow-hidden flex flex-col justify-between shrink-0">
                    <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-indigo-50/20 to-transparent -z-10" />
                    ...
                    <div>
                        ...
                        <div className="space-y-3.5">
                            ...
                            {eventType.requires_payment && eventType.price > 0 && (
                                <div className="flex items-center text-xs font-semibold text-slate-800 bg-indigo-50/30 p-3 rounded-xl shadow-xs border border-indigo-100/50">
                                    <CreditCard className="w-4 h-4 mr-2.5 text-indigo-500 shrink-0" />
