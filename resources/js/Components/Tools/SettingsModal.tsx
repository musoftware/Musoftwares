                            ...
                            <div className="flex items-center justify-between mt-2 pt-3 border-t border-white/10">
                                ...
                                <div className="w-48">
                                    <input 
                                        ...
                                        className="w-full bg-[#1c1c1c] border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-blue-500 transition-colors text-end"
