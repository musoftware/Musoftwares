...
const toastVariants = (variant: 'default' | 'destructive' = 'default') => {
  ...
  const defaultClasses = "border bg-background text-foreground";
  const destructiveClasses = "destructive group border-destructive bg-destructive text-destructive-foreground";

  return cn(baseClasses, variant === 'destructive' ? destructiveClasses : defaultClasses);
}
