...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    <SheetPrimitive.Content ref={ref as any} className={cn(sheetVariants({ side }), className)} {...(props as any)}>
      {children}
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title ref={ref as any} className={cn("text-lg font-semibold text-foreground", className)} {...(props as any)} />
))
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Description ref={ref as any} className={cn("text-sm text-muted-foreground", className)} {...(props as any)} />
))
