...
function AuthenticatedContent({
    ...
    return (
        <div className="min-h-screen bg-[#f5f5f7] dark:bg-[#090d16] font-sans text-[#1d1d1f] dark:text-[#f8fafc] flex flex-col selection:bg-[#0071e3]/20 selection:text-[#0071e3]">
            ...
            {/* Top Navigation */}
            <header
                className={cn("sticky z-40 w-full bg-white/80 dark:bg-[#0f172a]/80 backdrop-blur-md border-b border-black/5 dark:border-white/10 min-h-[64px] transition-all", isImpersonating ? "top-[36px]" : "top-0")}
                style={{
                        ...
                        <div className="flex items-center gap-8">
                            ...
                            <Sheet open={isMobileOpen} onOpenChange={setIsMobileOpen}>
                                <SheetTrigger asChild>
                                    <Button variant="ghost" size="icon" className="md:hidden -ms-2 text-[#1d1d1f]/75 dark:text-zinc-300 hover:text-[#1d1d1f] dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/10 rounded-full">
                                        <Menu className="h-5 w-5" />
                                    </Button>
                                </SheetTrigger>
                                <SheetContent side="left" className="w-[300px] sm:w-[350px] p-0 bg-white dark:bg-[#090d16] border-e border-black/5 dark:border-white/10 text-[#1d1d1f] dark:text-[#f8fafc]">
                                    <div className="flex flex-col h-full">
                                        <div className="p-5 border-b border-black/5 dark:border-white/10">
                                            <SafeLink href="/" className="flex items-center gap-2.5" onClick={() => setIsMobileOpen(false)}>
                                                <div className="w-8 h-8 rounded-xl bg-black dark:bg-white/10 flex items-center justify-center text-white shadow-sm shrink-0">
                                                    <svg className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                                                        <path d="M4 17V7l8 5 8-5v10" />
                                                    </svg>
                                                </div>
                                                <span className="text-lg font-semibold tracking-[-0.03em] text-[#1d1d1f] dark:text-white font-sans">
                                                    Musoftware
                                                </span>
                                                <span className="text-[10px] font-semibold tracking-wider uppercase px-2 py-0.5 rounded-full bg-[#f5f5f7] dark:bg-zinc-800 border border-black/5 dark:border-white/10 text-[#1d1d1f]/60 dark:text-zinc-400">
                                                    STUDIO
                                                </span>
                                            </SafeLink>
                                        </div>
                                        <div className="flex-1 overflow-y-auto p-4 space-y-6">
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                {auth?.team_member ? (
                                                    <SafeLink href={safeRoute('sso.redirect', { system: 'erp' })} onClick={() => setIsMobileOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-[#f5f5f7] dark:hover:bg-zinc-800/80 text-[#1d1d1f] dark:text-zinc-100 font-medium">
                                                        <LayoutDashboard className="w-5 h-5 text-[#0071e3]" /> {__('general.dashboard')}</SafeLink>
                                                ) : (
                                                    <>
                                                        <SafeLink href={safeRoute('dashboard')} onClick={() => setIsMobileOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-[#f5f5f7] dark:hover:bg-zinc-800/80 text-[#1d1d1f] dark:text-zinc-100 font-medium">
                                                            <LayoutDashboard className="w-5 h-5 text-[#0071e3]" /> {__('general.dashboard')}</SafeLink>
                                                        
                                                        {/* Financials & Balance in Drawer */}
                                                        <div className="my-2 p-3 bg-[#f5f5f7] dark:bg-zinc-900 rounded-2xl border border-black/5 dark:border-white/10 space-y-2.5">
                                                            <div className="flex items-center justify-between text-xs">
                                                                <span className="text-[#1d1d1f]/60 dark:text-zinc-400 font-medium">{__('general.wallet_balance')}</span>
                                                                <SafeLink
                                                                    href={safeRoute('financial.transactions')}
                                                                    onClick={() => setIsMobileOpen(false)}
                                                                    className="font-bold text-[#1d1d1f] dark:text-zinc-100 hover:text-[#0071e3] flex items-center gap-1.5"
                                                                >
                                                            ...
                                                            <div className="flex items-center justify-between text-xs">
                                                                <span className="text-[#1d1d1f]/60 dark:text-zinc-400 font-medium">{__('general.points_connects_balance')}</span>
                                                                <SafeLink
                                                                    href={safeRoute('points.index', undefined, '/points')}
                                                                    onClick={() => setIsMobileOpen(false)}
                                                                    className="font-bold text-amber-800 dark:text-amber-300 hover:text-amber-900 flex items-center gap-1.5"
                                                                >
                                                        ...
                                                        <div className="mt-4 pt-2 border-t border-black/5 dark:border-white/10">
                                                            <Accordion className="w-full">
                                                                ...
                                                                <AccordionItem value="workspace" className="border-b-0">
                                                                    ...
                                                                    <AccordionContent className="pb-1 px-2">
                                                                        <div className="flex flex-col space-y-1 mt-1 border-s-2 border-black/5 dark:border-white/10 ms-5 ps-4">
                                                                            <SafeLink href={safeRoute('client.projects.index')} onClick={() => setIsMobileOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-[#f5f5f7] dark:hover:bg-zinc-800/80 text-[#1d1d1f]/80 dark:text-zinc-200 font-medium">
                                                                                <FolderKanban className="w-4 h-4 text-[#0071e3]" /> {__('general.projects')}
                                                                            </SafeLink>
                                                                            <SafeLink href={safeRoute('client.projects.all-tasks')} onClick={() => setIsMobileOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-[#f5f5f7] dark:hover:bg-zinc-800/80 text-[#1d1d1f]/80 dark:text-zinc-200 font-medium">
                                                                ...
                                                                <AccordionItem value="financials" className="border-b-0">
                                                                    ...
                                                                    <AccordionContent className="pb-1 px-2">
                                                                        <div className="flex flex-col space-y-1 mt-1 border-s-2 border-black/5 dark:border-white/10 ms-5 ps-4">
                                                                            <SafeLink href={safeRoute('billing.invoices.index')} onClick={() => setIsMobileOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-[#f5f5f7] dark:hover:bg-zinc-800/80 text-[#1d1d1f]/80 dark:text-zinc-200 font-medium">
                                                                                <FileText className="w-4 h-4 text-[#0071e3]" /> {__('general.my_invoices')}
                                                                            </SafeLink>
                                                                            <SafeLink href={safeRoute('financial.transactions')} onClick={() => setIsMobileOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-[#f5f5f7] dark:hover:bg-zinc-800/80 text-[#1d1d1f]/80 dark:text-zinc-200 font-medium">
                                                                                <ArrowRightLeft className="w-4 h-4 text-[#0071e3]" /> {__('general.transactions')}
                                                                            </SafeLink>
                                                                            <SafeLink href={safeRoute('financial.withdrawals')} onClick={() => setIsMobileOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-[#f5f5f7] dark:hover:bg-zinc-800/80 text-[#1d1d1f]/80 dark:text-zinc-200 font-medium">
                            ...
                            <SafeLink href="/" className="flex items-center gap-2.5">
                                ...
                                <span className="font-semibold text-[17px] tracking-[-0.03em] text-[#1d1d1f] dark:text-white hidden sm:inline">Musoftware</span>
                                <span className="text-[10px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded-full bg-[#f5f5f7] dark:bg-zinc-800 border border-black/5 dark:border-white/10 text-[#1d1d1f]/60 dark:text-zinc-400 hidden lg:inline">
                                    STUDIO
                                </span>
                            </SafeLink>
                                        ...
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="start" className="w-[960px] max-h-[85vh] overflow-y-auto p-5 grid grid-cols-4 gap-5 rounded-[24px] border border-black/10 dark:border-white/10 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-xl text-[#1d1d1f] dark:text-zinc-100 isolate z-50 shadow-[0_20px_50px_rgba(0,0,0,0.12)] dark:shadow-2xl">
                                                ...
                                                <div className="flex flex-col gap-1.5">
                                                    ...
                                                    <UnifiedMenuItem
                                                        href={safeRoute('client.projects.index')}
                                                        icon={FolderKanban}
                                                        title={__('general.projects')}
                                                        description={__('general.projects_desc')}
                                                        isActive={isProjectsMenuActive}
                                                    />

                                                    <UnifiedMenuItem
                                                        href={safeRoute('client.projects.all-tasks')}
                                                        icon={ListTodo}
                                                        title={__('general.all_tasks')}
                                                        description={__('general.all_tasks_desc')}
                                                        isActive={isAllTasksMenuActive}
                                                    />
                                                ...
                                                <div className="flex flex-col gap-1.5">
                                                    ...
                                                    <UnifiedMenuItem
                                                        href={safeRoute('billing.invoices.index')}
                                                        icon={FileText}
                                                        title={__('general.my_invoices')}
                                                        description={__('general.my_invoices_desc')}
                                                        isActive={isInvoicesMenuActive}
                                                    />
                                                    ...
                                                    <UnifiedMenuItem
                                                        ...
                                                        description={__('general.transactions_desc')}
                                                        isActive={isTransactionsMenuActive}
                                                    />
                                                    ...
                                                    <UnifiedMenuItem
                                                        ...
                                                        description={__('general.request_withdrawal_desc')}
                                                        isActive={isWithdrawalsMenuActive}
                                                    />

                                                    <UnifiedMenuItem
                                                        href={safeRoute('financial.payout-methods.index')}
                                                        icon={CreditCard}
                                                        title={__('general.payout_methods')}
                                                        description={__('general.payout_methods_desc')}
                                                        isActive={isPayoutMethodsMenuActive}
                                                    />
                                                ...
                                                <div className="flex flex-col gap-1.5">
                                                    ...
                                                    <UnifiedMenuItem
                                                        ...
                                                        icon={Calculator}
                                                        title={__('general.estimator') || 'Estimator'}
                                                        description={__('general.cost_estimator_desc') || 'Instant cost calculation'}
                                                        isActive={isEstimatorMenuActive}
                                                    />
                        ...
                        <div className="flex items-center gap-2 sm:gap-2.5">
                            ...
                            {!auth?.team_member && (
                                <div className="hidden md:flex items-center gap-2 font-sans text-xs">
                                    ...
                                    <SafeLink
                                        href={safeRoute('financial.add-balance')}
                                        className="inline-flex items-center gap-1.5 h-8 px-3 text-xs font-medium border border-black/10 dark:border-white/10 bg-white dark:bg-zinc-900 text-[#1d1d1f] dark:text-zinc-100 hover:bg-[#f5f5f7] dark:hover:bg-zinc-800 rounded-full shadow-2xs transition-all shrink-0"
                                    >
                                        <Plus className="w-3.5 h-3.5 shrink-0 text-[#0071e3] dark:text-[#3898ec]" />
                                    ...
                                    <div className="relative">
                                        <SafeLink
                                            href={safeRoute('financial.transactions')}
                                            className="inline-flex items-center gap-1.5 h-8 px-3 bg-[#f5f5f7] dark:bg-zinc-800/80 hover:bg-[#ebebed] dark:hover:bg-zinc-800 border border-black/5 dark:border-white/10 rounded-full transition-all text-xs font-semibold text-[#1d1d1f] dark:text-zinc-100 shrink-0"
                                    ...
                                    <SafeLink
                                        href={safeRoute('points.index', undefined, '/points')}
                                        className="inline-flex items-center gap-1.5 h-8 px-2.5 bg-amber-50 dark:bg-amber-950/30 hover:bg-amber-100/60 dark:hover:bg-amber-950/50 border border-amber-200/60 dark:border-amber-500/20 rounded-full transition-all text-xs font-semibold text-amber-800 dark:text-amber-300 shrink-0"
                            ...
                            <DropdownMenu>
                                <div className="relative inline-block">
                                    <DropdownMenuTrigger className="w-8 h-8 rounded-full bg-white dark:bg-zinc-900 hover:bg-[#f5f5f7] dark:hover:bg-zinc-800 border border-black/10 dark:border-white/10 inline-flex items-center justify-center text-[#1d1d1f]/75 dark:text-zinc-300 hover:text-[#1d1d1f] dark:hover:text-white transition-all relative outline-none shrink-0 cursor-pointer shadow-2xs">
                                ...
                                <DropdownMenuContent align="end" className="w-80 p-0 rounded-[20px] border border-black/10 dark:border-white/10 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-xl text-[#1d1d1f] dark:text-zinc-100 isolate z-50 shadow-2xl">
                                    <div className="px-4 py-3 border-b border-black/5 dark:border-white/10 flex justify-between items-center">
                                        <span className="font-bold text-[#1d1d1f] dark:text-zinc-100 text-xs font-sans">{__('general.notifications')}</span>
                                        {notifications?.unread_count > 0 && (
                                            <SafeLink 
                                                href={safeRoute('notifications.mark-all-read')} 
                                                method="post" 
                                                as="button" 
                                                className="text-[11px] text-[#0071e3] dark:text-[#3898ec] hover:underline font-semibold bg-transparent border-0 cursor-pointer p-0"
                                    ...
                                    <div className="max-h-[300px] overflow-y-auto p-2 space-y-1">
                                        {notifications?.recent && notifications.recent.length > 0 ? (
                                            notifications.recent.map((n: any) => (
                                                <div key={n.id} className="p-2 hover:bg-[#f5f5f7] dark:hover:bg-zinc-800 rounded-[12px] border-0 text-xs flex justify-between items-start gap-1 relative group transition-colors">
                                                    <SafeLink 
                                                    ...
                                                    >
                                                        <p className="text-[#1d1d1f] dark:text-zinc-100 font-semibold leading-tight font-sans text-xs">{n.data?.title || n.data?.message || __('general.new_notification')}</p>
                                                        {(n.data?.body || (n.data?.title && n.data?.message)) && (
                                                            <p className="text-[#1d1d1f]/60 dark:text-zinc-400 text-[11px] mt-0.5 line-clamp-2 font-sans">{n.data?.body || n.data?.message}</p>
                                                        )}
                                                        <span className="text-[10px] text-[#1d1d1f]/40 dark:text-zinc-500 block mt-1">{n.created_at ? new Date(n.created_at).toLocaleDateString() : ''}</span>
                                                    </SafeLink>
                                                    <SafeLink 
                                                        href={safeRoute('notifications.mark-read', { id: n.id, no_redirect: 1 })} 
                                                        method="post" 
                                                        as="button" 
                                                        className="text-[10px] font-semibold text-[#0071e3] dark:text-[#3898ec] hover:underline shrink-0 bg-transparent border-0 cursor-pointer p-1 opacity-0 group-hover:opacity-100 transition-opacity"
                                                    >{__('general.mark_read')}</SafeLink>
                                                </div>
                                            ))
                                        ) : (
                                            <div className="px-2 py-6 text-center text-xs text-[#1d1d1f]/50 dark:text-zinc-500">{__('general.no_new_notifications')}</div>
                                        )}
                                    </div>
                                    <div className="p-2 border-t border-black/5 dark:border-white/10">
                                        <SafeLink 
                                            href={safeRoute('notifications.index')} 
                                            className={cn(buttonVariants({ variant: 'ghost', size: 'sm' }), "w-full text-xs font-semibold text-[#0071e3] dark:text-[#3898ec] hover:text-[#0077ed] justify-center rounded-xl hover:bg-[#f5f5f7] dark:hover:bg-zinc-800")}
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger className="outline-none relative shrink-0">
                                    <Avatar className="h-8 w-8 rounded-full border border-black/10 dark:border-white/10 cursor-pointer hover:border-black/30 dark:hover:border-white/30 transition-all">
                                        <AvatarFallback className="bg-black dark:bg-zinc-800 text-white font-sans font-bold text-xs rounded-full">
                                            {displayName.substring(0, 2).toUpperCase() || 'US'}
                                        </AvatarFallback>
                                    </Avatar>
                                </DropdownMenuTrigger>
                                <DropdownMenuContent align="end" className="w-56 p-2 rounded-[20px] border border-black/10 dark:border-white/10 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-xl text-[#1d1d1f] dark:text-zinc-100 isolate z-50 shadow-2xl">
                                    <div className="px-3 py-2.5 mb-1.5 border-b border-black/5 dark:border-white/10">
                                        <p className="text-xs font-bold text-[#1d1d1f] dark:text-zinc-100 font-sans truncate">{displayName}</p>
                                        <p className="text-[11px] text-[#1d1d1f]/60 dark:text-zinc-400 truncate mt-0.5">{displayEmail}</p>
                                    </div>
                                        ...
                                        <>
                                            <DropdownMenuGroup className="space-y-0.5">
                                                {user?.role === 'admin' && (
                                                    ...
                                                    >
                                                        <Shield className="me-2 h-3.5 w-3.5 text-[#0071e3] dark:text-[#3898ec]" />{__('general.admin_dashboard')}</DropdownMenuItem>
                                                )}
                                                ...
                                                {(user?.roles?.includes('moderator') || user?.roles?.includes('support_agent')) && (
                                                    ...
                                                    >
                                                        <LifeBuoy className="me-2 h-3.5 w-3.5 text-[#0071e3] dark:text-[#3898ec]" />{__('general.manage_tickets')}</DropdownMenuItem>
                                                )}
                                                <DropdownMenuItem 
                                                    className="cursor-pointer rounded-[12px] text-xs text-[#1d1d1f] dark:text-zinc-200 hover:bg-[#f5f5f7] dark:hover:bg-zinc-800 p-2 transition-colors"
                                                    render={<SafeLink href={safeRoute('profile.edit')} className="flex items-center w-full" />}
                                                >
                                                    <User className="me-2 h-3.5 w-3.5 text-[#1d1d1f]/60 dark:text-zinc-400" />{__('general.my_profile')}</DropdownMenuItem>
                                                <DropdownMenuItem 
                                                    className="cursor-pointer rounded-[12px] text-xs text-[#1d1d1f] dark:text-zinc-200 hover:bg-[#f5f5f7] dark:hover:bg-zinc-800 p-2 transition-colors"
                                                    render={<SafeLink href={safeRoute('kyc.index')} className="flex items-center w-full" />}
                                                >
                                                    <Shield className="me-2 h-3.5 w-3.5 text-[#1d1d1f]/60 dark:text-zinc-400" />{__('general.identity_verification')}</DropdownMenuItem>
                                                <DropdownMenuItem 
                                                    className="cursor-pointer rounded-[12px] text-xs text-[#1d1d1f] dark:text-zinc-200 hover:bg-[#f5f5f7] dark:hover:bg-zinc-800 p-2 transition-colors"
                                                    render={<SafeLink href={safeRoute('financial.transactions')} className="flex items-center w-full" />}
                                                >
                                                    <History className="me-2 h-3.5 w-3.5 text-[#1d1d1f]/60 dark:text-zinc-400" />{__('general.balance_history')}</DropdownMenuItem>
                                                <DropdownMenuItem 
                                                    className="cursor-pointer rounded-[12px] text-xs text-[#1d1d1f] dark:text-zinc-200 hover:bg-[#f5f5f7] dark:hover:bg-zinc-800 p-2 transition-colors"
                                                    render={<SafeLink href={safeRoute('profile.edit')} className="flex items-center w-full" />}
                                                >
                                                    <Shield className="me-2 h-3.5 w-3.5 text-[#1d1d1f]/60 dark:text-zinc-400" />{__('general.security_settings')}</DropdownMenuItem>
                                                <DropdownMenuItem 
                                                    className="cursor-pointer rounded-[12px] text-xs text-[#1d1d1f] dark:text-zinc-200 hover:bg-[#f5f5f7] dark:hover:bg-zinc-800 p-2 transition-colors"
                                                    render={<SafeLink href={safeRoute('settings.backup.index')} className="flex items-center w-full" />}
                                                >
                                                    <Download className="me-2 h-3.5 w-3.5 text-[#1d1d1f]/60 dark:text-zinc-400" />{__('general.backup_restore')}</DropdownMenuItem>
                                                <DropdownMenuItem 
                                                    className="cursor-pointer rounded-[12px] text-xs text-[#1d1d1f] dark:text-zinc-200 hover:bg-[#f5f5f7] dark:hover:bg-zinc-800 p-2 transition-colors"
                                                    render={<SafeLink href={safeRoute('settings.automations.index')} className="flex items-center w-full" />}
                                                >
                                                    <Settings className="me-2 h-3.5 w-3.5 text-[#1d1d1f]/60 dark:text-zinc-400" />{__('general.automations')}</DropdownMenuItem>
                                                <DropdownMenuItem 
                                                    className="cursor-pointer rounded-[12px] text-xs text-[#1d1d1f] dark:text-zinc-200 hover:bg-[#f5f5f7] dark:hover:bg-zinc-800 p-2 transition-colors"
                                                    render={<SafeLink href={safeRoute('subscriptions.manage')} className="flex items-center w-full" />}
                                                >
                                                    <Box className="me-2 h-3.5 w-3.5 text-[#1d1d1f]/60 dark:text-zinc-400" /> {__('general.subscriptions')}</DropdownMenuItem>
                                            </DropdownMenuGroup>
                                            
                                            <DropdownMenuSeparator className="my-1.5 bg-black/5 dark:bg-white/10" />
                                            
                                            <DropdownMenuItem 
                                                className="cursor-pointer rounded-[12px] text-xs font-semibold text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/30 p-2 transition-colors"
            ...
            {header && (
                <div className="bg-white dark:bg-[#0f172a] border-b border-slate-200 dark:border-zinc-800 py-4 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-full mx-auto">
                        <div className="text-xl font-semibold tracking-tight text-slate-900 dark:text-zinc-100">{header}</div>
                    </div>
                </div>
            )}
