                                    ...
                                    <DropdownMenuContent align="start" className="w-[450px] p-4 grid grid-cols-2 gap-4 rounded-xl shadow-xl border border-slate-200 bg-white isolate z-50">
                                        <div>
                                            ...
                                            <div className="space-y-0.5">
                                                <Link href={safeRoute('erp.wallet.show', user?.id || 1)} className="flex items-center gap-3 px-2 py-1.5 rounded-md hover:bg-slate-50 text-sm font-medium text-slate-700">
                                                    <ArrowRightLeft className="w-4 h-4 text-slate-400" /> Transactions
                                                </Link>
                                                <Link href={safeRoute('erp.withdrawals.index')} className="flex items-center gap-3 px-2 py-1.5 rounded-md hover:bg-slate-50 text-sm font-medium text-slate-700">
                                                    <ArrowUpRight className="w-4 h-4 text-slate-400" /> Request Withdrawal
                                                </Link>
                                                <Link href="#" className="flex items-center gap-3 px-2 py-1.5 rounded-md hover:bg-slate-50 text-sm font-medium text-slate-700">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="hidden md:flex items-center gap-3 mr-2">
                                ...
                                <Link href={safeRoute('erp.wallet.show', user?.id || 1)} className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 hover:bg-slate-200 rounded-full transition-colors text-sm font-medium text-slate-900">
                                    <Wallet className="w-4 h-4 text-slate-500" /> $1,250.45
                                </Link>
