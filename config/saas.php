...
return [
    ...
    */
    'addons' => [
        ...
        'gold-auto-saving' => ['price' => 500, 'name' => 'Automated Savings', 'desc' => 'Weekly/monthly auto save', 'icon' => 'RefreshCw', 'parent' => 'gold-saver'],
        ...
        'gold-family-accounts' => ['price' => 500, 'name' => 'Family Accounts', 'desc' => 'Shared goals & child accounts', 'icon' => 'Users', 'parent' => 'gold-saver'],
        'gold-purchase-tracking' => ['price' => 500, 'name' => 'Purchase Tracking', 'desc' => 'Invoices, grams & karat', 'icon' => 'ShoppingCart', 'parent' => 'gold-saver'],
        'gold-smart-notifications' => ['price' => 500, 'name' => 'Smart Notifications', 'desc' => 'Market drops & opportunities', 'icon' => 'Zap', 'parent' => 'gold-saver'],
        'gold-goal-tracking' => ['price' => 500, 'name' => 'Goal Tracking', 'desc' => 'Target-based saving system', 'icon' => 'Target', 'parent' => 'gold-saver'],
        'gold-installments' => ['price' => 500, 'name' => 'Installment Plans', 'desc' => 'Monthly installment tracking', 'icon' => 'Calendar', 'parent' => 'gold-saver'],
        'gold-multi-currency' => ['price' => 500, 'name' => 'Multi Currency', 'desc' => 'Track in different currencies', 'icon' => 'Coins', 'parent' => 'gold-saver'],
        ...
        'gold-market-insights' => ['price' => 500, 'name' => 'Market Insights', 'desc' => 'Trends & highest prices', 'icon' => 'Lightbulb', 'parent' => 'gold-saver'],
        'gold-calculator' => ['price' => 500, 'name' => 'Conversion Calculator', 'desc' => 'EGP ↔ grams & karats', 'icon' => 'Calculator', 'parent' => 'gold-saver'],
        'gold-savings-challenges' => ['price' => 500, 'name' => 'Savings Challenges', 'desc' => 'Gamified 30-day challenges', 'icon' => 'Trophy', 'parent' => 'gold-saver'],
        'gold-referral' => ['price' => 500, 'name' => 'Referral System', 'desc' => 'Invite family & friends', 'icon' => 'UserPlus', 'parent' => 'gold-saver'],
        'gold-exports' => ['price' => 500, 'name' => 'PDF & Exports', 'desc' => 'Download reports & data', 'icon' => 'Download', 'parent' => 'gold-saver'],
        'gold-vault' => ['price' => 500, 'name' => 'Secure Vault', 'desc' => 'Store certificates & receipts', 'icon' => 'Shield', 'parent' => 'gold-saver'],
        'gold-white-label' => ['price' => 500, 'name' => 'White Label', 'desc' => 'For gold shops & businesses', 'icon' => 'Star', 'parent' => 'gold-saver'],
        'gold-api' => ['price' => 500, 'name' => 'API Access', 'desc' => 'Programmatic data access', 'icon' => 'Code', 'parent' => 'gold-saver'],
        'gold-multi-user' => ['price' => 500, 'name' => 'Multi User / Team', 'desc' => 'For investment firms', 'icon' => 'Users', 'parent' => 'gold-saver'],
        'gold-shop-integration' => ['price' => 500, 'name' => 'Gold Shop Integration', 'desc' => 'Connect with local vendors', 'icon' => 'Store', 'parent' => 'gold-saver'],
        'gold-reminders' => ['price' => 500, 'name' => 'Recurring Reminders', 'desc' => 'Time to save prompts', 'icon' => 'Clock', 'parent' => 'gold-saver'],
        'gold-historical-charts' => ['price' => 500, 'name' => 'Premium Charts', 'desc' => 'Advanced historical data', 'icon' => 'LineChart', 'parent' => 'gold-saver'],
        'gold-news-feed' => ['price' => 500, 'name' => 'Gold News Feed', 'desc' => 'Latest market news', 'icon' => 'Rss', 'parent' => 'gold-saver'],
        'gold-buy-sell-analytics' => ['price' => 500, 'name' => 'Buy/Sell Analytics', 'desc' => 'History & trade performance', 'icon' => 'Activity', 'parent' => 'gold-saver'],
        'gold-offline-mode' => ['price' => 500, 'name' => 'Offline Mode', 'desc' => 'Access data without internet', 'icon' => 'WifiOff', 'parent' => 'gold-saver'],
        'gold-mobile-sync' => ['price' => 500, 'name' => 'Mobile App Sync', 'desc' => 'Sync with iOS/Android apps', 'icon' => 'Smartphone', 'parent' => 'gold-saver'],
        'gold-insurance' => ['price' => 500, 'name' => 'Insurance Tracking', 'desc' => 'Safety tracking for physical gold', 'icon' => 'Umbrella', 'parent' => 'gold-saver'],
    ],
];
