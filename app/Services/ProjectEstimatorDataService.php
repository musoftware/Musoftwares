    ...
    public function getEstimatorData(float $exchangeRate = 50.0): array
    {
        $platforms = [
            ...
            'landing' => [
                'key' => 'landing',
                'title' => 'Landing Page',
                'title_ar' => 'صفحة هبوط / Landing Page',
                'rate_usd' => 60,
                'rate_egp' => round(60 * $exchangeRate),
                'unit' => 'Page',
                'unit_ar' => 'صفحة',
                'icon' => 'Sparkles',
                'badge' => '$60/page',
                'description' => 'High-converting animated frontend landing pages, long detailed sections, with custom interactions and CMS.',
            ],
            'mobile' => [
                'key' => 'mobile',
        ...
        $modules = [
            ...
            'landing' => [
                [
                    ...
                    'title' => 'UI/UX Design from Scratch (Without Figma)',
                    'category' => 'core',
                    'price_usd' => 200,
                    'price_egp' => 10000,
                    'platform' => 'landing',
                    'icon' => 'Shield',
                    'desc' => 'Bespoke UI/UX design in Figma from scratch before development (+10,000 EGP).',
                ],
                [
        ...
        return [
            'overview' => [
                ...
                'tagline' => 'Instant, transparent estimation for Websites, Landing Pages, Mobile Apps, and Desktop software.',
                'tagline_ar' => 'تقدير فوري وشفاف لتكلفة المواقع، صفحات الهبوط التفاعلية، تطبيقات الموبايل، وبرامج سطح المكتب.',
