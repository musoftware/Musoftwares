...
class ComponentBenchmarkRates
{
    ...
    public static function getDefaultComponents(): array
    {
        return [
            ...
            'metaapi_mt5' => [
                'name_ar'          => 'ربط منصة MetaApi وبروكر MT5 وتنفيذ الصفقات (MetaApi MT5 Broker Connection & Trading Execution)',
                'name_en'          => 'MetaApi MT5 Broker Connection & Trading Execution',
                'standalone_hours' => 6,
                'marginal_hours'   => 3,
                'complexity'       => 'high',
                'keywords'         => ['metaapi', 'mt5', 'metatrader', 'broker', 'trading execution', 'تداول', 'بروكر', 'ميتاتريدر', 'تنفيذ صفقات', 'ربط ميتاتريدر', 'meta api'],
            ],
            'tradingview_chart' => [
                'name_ar'          => 'شارتات TradingView التفاعلية وربط الوسيط (TradingView Charting Library + Broker API Integration)',
                'name_en'          => 'TradingView Charting Library + Broker API Integration',
                'standalone_hours' => 5,
                'marginal_hours'   => 2,
                'complexity'       => 'medium',
                'keywords'         => ['tradingview', 'charting', 'شارت', 'رسم بياني للتداول', 'trading chart', 'مخطط تداول', 'tradingview library', 'مؤشرات تداول', 'شارتات'],
            ],
            'autotrade_engine' => [
                'name_ar'          => 'محرك التداول الآلي وإدارة دورة حياة الأوامر (Auto-Trade Engine & Lifecycle Logic)',
                'name_en'          => 'Auto-Trade Engine & Lifecycle Logic',
                'standalone_hours' => 6,
                'marginal_hours'   => 3,
                'complexity'       => 'high',
                'keywords'         => ['auto trade', 'autotrade', 'تداول آلي', 'محرك تداول', 'بوت تداول', 'trade engine', 'lifecycle logic', 'تداول تلقائي', 'تنفيذ آلي', 'صفقات آلية'],
            ],
            'loss_limits_closure' => [
                'name_ar'          => 'حدود الخسارة العامة والإغلاق التلقائي للصفقات (Global Loss Limits & Automatic Position Closure)',
                'name_en'          => 'Global Loss Limits & Automatic Position Closure',
                'standalone_hours' => 4,
                'marginal_hours'   => 2,
                'complexity'       => 'medium',
                'keywords'         => ['loss limit', 'risk management', 'إيقاف الخسارة', 'حدود الخسارة', 'اغلاق تلقائي', 'drawdown', 'تأمين الحساب', 'position closure', 'وقف خسارة تلقائي', 'إدارة مخاطر'],
            ],
            'signal_analytics' => [
                'name_ar'          => 'تحليلات الإشارات وحسابات أداء التداول (Signal Analytics & Trading Performance Calculations)',
                'name_en'          => 'Signal Analytics & Trading Performance Calculations',
                'standalone_hours' => 4,
                'marginal_hours'   => 2,
                'complexity'       => 'medium',
                'keywords'         => ['signal analytics', 'trading performance', 'تحليل إشارات', 'أداء التداول', 'احصائيات التداول', 'win rate', 'winrate', 'pnl', 'عائد الصفقات', 'تحليلات الصفقات', 'حساب الأرباح'],
            ],
            'channel_mirror' => [
                'name_ar'          => 'مرآة القنوات وإعادة توجيه إشارات التداول (Channel Mirror / Signal Routing)',
                'name_en'          => 'Channel Mirror / Signal Routing',
                'standalone_hours' => 5,
                'marginal_hours'   => 2,
                'complexity'       => 'medium',
                'keywords'         => ['channel mirror', 'signal routing', 'نسخ قنوات', 'توجيه إشارات', 'نسخ إشارات', 'signal copier', 'mirror channel', 'تكرار صفقات', 'نسخ التداول', 'قنوات إشارات'],
            ],
            'chat_messaging' => [
