...
class EgyptianMarketBenchmarkRates
{
    ...
    public static function getBenchmarks(): array
    {
        return [
            ...
            'todo_simple_crud' => [
                'name_ar'  => 'تطبيق ويب بسيط / CRUD / قائمة مهام (Simple Web App)',
                'name_en'  => 'Simple Web App / CRUD / Todo App',
                'base_usd' => 60,
                'min_usd'  => 40,
                'max_usd'  => 150,
                'avg_egp'  => 3000,
            ...
            'mvp_web_app' => [
                'name_ar'  => 'تطبيق ويب MVP متوسط التعقيد',
                'name_en'  => 'MVP Web Application',
                'base_usd' => 250,
                'min_usd'  => 150,
                'max_usd'  => 500,
                'avg_egp'  => 12500,
