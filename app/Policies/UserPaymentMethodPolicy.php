...
class UserPaymentMethodPolicy
{
     ...
     */
    public function restore(User $user, UserPaymentMethod $userPaymentMethod): bool
    {
        return isset($userPaymentMethod->user_id) ? $user->id === $userPaymentMethod->user_id : false;
    }
     ...
     */
    public function forceDelete(User $user, UserPaymentMethod $userPaymentMethod): bool
    {
        return isset($userPaymentMethod->user_id) ? $user->id === $userPaymentMethod->user_id : false;
    }
}
