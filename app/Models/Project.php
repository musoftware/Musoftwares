...
class Project extends Model
{
    ...
    public function hour_rate_client()
    {
        if ($this->client->currency == 2) {
            ...
            $price_21 = \App\Models\GoldPrice::query()->where(DB::raw('DATE(price_date)'), $item->price_date)->select(DB::raw('avg(price_21k) as price_21k'))->groupBy(DB::raw('DATE(price_date)'))->first();
