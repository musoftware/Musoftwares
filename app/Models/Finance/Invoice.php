...
class Invoice extends Model
{
    ...
    public static function UnpaidInvoicesBusiness()
    {
        ...
        foreach ($invoices as $invoice) {
            $unpaid += CurrenciesExchange::RateToday($invoice->unpaid, $invoice->currency, \App\Models\Finance\CurrenciesExchange::BusinessCurrency());
        }
        return $unpaid;
    }
    ...
    {
        return $this->belongsTo(\App\Models\Marketplace\Project::class);
    }
    ...
    public function cancel_invoice()
    {
        DB::transaction(function () {
            ...
            if (!empty($this->project_id)) {
                $project = \App\Models\Marketplace\Project::find($this->project_id);
                $client = User::find($this->user_id);
