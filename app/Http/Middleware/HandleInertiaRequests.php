        ...
        return [
            ...
            'auth' => [
                'user' => $user ? [
                    ...
                    'currency' => $user->currencyRelation?->currency ?? Currency::findCached($user->currency_id)?->currency,
                    'currency_symbol' => $user->currencyRelation?->symbol ?? Currency::findCached($user->currency_id)?->symbol,
                    ...
                    'is_reseller' => method_exists($user, 'isReseller') ? $user->isReseller() : false,
