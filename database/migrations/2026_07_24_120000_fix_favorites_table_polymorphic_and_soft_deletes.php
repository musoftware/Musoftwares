...
return new class extends Migration
{
    public function up(): void
    {
        if (Schema::hasTable('favorites')) {
            // 1. Ensure favoritable_type column exists
            ...
            // 2. Ensure favoritable_id column exists
            ...
            // 3. Ensure deleted_at soft deletes column exists
            ...
            // 4. Migrate data from legacy service_id column if present
            if (Schema::hasColumn('favorites', 'service_id')) {
                ...
                // Safely drop any foreign keys referencing service_id
                try {
