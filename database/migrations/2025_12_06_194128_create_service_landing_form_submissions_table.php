...
return new class extends Migration
{
    ...
    {
        Schema::create('service_landing_form_submissions', function (Blueprint $table) {
            $table->id();
            ...
            $table->json('form_data'); // Store all question answers as JSON
    ...
    {
        Schema::dropIfExists('service_landing_form_submissions');
    }
};
